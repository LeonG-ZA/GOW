...
namespace Server.Items
{
    public class LampController : Item
    {
        ...
        {
            var eable = Map.Malas.GetMobilesInBounds(Rect);
        ...
        public static string[] m_Combinations = new string[]
			{
        ...
        public static string GenerateCode(string puzzle)
        {
            ...
            while (new_code == old_code)
                new_code = Utility.RandomList(m_Combinations);
        ...
        public LampController(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            m_Box = reader.ReadItem() as LampPuzzleBox;

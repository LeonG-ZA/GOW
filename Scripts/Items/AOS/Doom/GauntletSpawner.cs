...
namespace Server.Engines.Doom
{
    ...
    public class GauntletSpawner : Item
    {
        ...
        {
            CommandSystem.Register("GenGauntlet", AccessLevel.Developer, new CommandEventHandler(GenGauntlet_OnCommand));
        }
        ...
        public static void CreateVarietyDealer(int x, int y)
        {
            ...
            foreach (var item in dealer.GetEquippedItems())
            {
        ...
        [Usage("GenGauntlet")]
        [Description("Genera el sistema de champions de Doom2.")]

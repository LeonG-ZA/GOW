...
namespace Server.Items
{
	public class RoseRugSmallEast : BaseAddon, IRewardItem
	{
		...
		public override void Serialize( GenericWriter writer )
		{
			...
			if ( m_Timer != null )
				...
				writer.Write( (DateTime) DateTime.UtcNow + TimeSpan.FromDays( 7 ) );
		}
        ...
        public override void Deserialize( GenericReader reader )
		{
			...
			m_Timer = Timer.DelayCall( next - DateTime.UtcNow, TimeSpan.FromDays( 7 ), new TimerCallback( GiveRSeed ) );
		}
	...
	public class RoseRugSmallEastDeed : BaseAddonDeed, IRewardItem
	{
        ...
        public override int LabelNumber { get { return 1150049; } } // Rose Rug (East)

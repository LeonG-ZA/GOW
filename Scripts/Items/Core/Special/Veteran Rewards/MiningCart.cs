...
namespace Server.Items
{
    ...
    public class MiningCart : BaseAddon, IRewardItem
    {
        ...
        public override void OnComponentUsed(AddonComponent c, Mobile from)
        {
            ...
            * typical GOW shard will have (GIW's scaled down account aging system makes this a unique problem),
            ...
            *
            * If youd like your GOW's carts/stumps to work the way they did before, simply replace the check

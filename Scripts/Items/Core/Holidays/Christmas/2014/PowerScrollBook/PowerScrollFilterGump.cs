...
namespace Server.Items
{
    public class PowerScrollFilterGump : Gump
    {
                                ...
                                switch (type)
                                {
                                    ...
                                    case 1:
                                        switch (filters[index, 1])
                                        {
                                            ...
                                            case 1: f.SkillValue = 5; break;
                                            case 2: f.SkillValue = 10; break;
                                            case 3: f.SkillValue = 15; break;
                                            case 4: f.SkillValue = 20; break;
                                        }
                                        break;
                                }
            ...
            : base(12, 24)
        {
            ...
            switch (f.SkillValue)
            {
                case 5: ValueIndex = 1; break;
                case 10: ValueIndex = 2; break;
                case 15: ValueIndex = 3; break;
                case 20: ValueIndex = 4; break;
            }

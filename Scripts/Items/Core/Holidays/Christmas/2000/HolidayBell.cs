...
namespace Server.Items
{
    ...
    {
        private static readonly string[] HolidayBellNames = new string[]
        {
            "Adrick",
            "Alai",
            "Bulldoz",
        ...
        private static readonly int[] Hues = new int[]
        {
        ...
        [Constructable]
        public HolidayBell()
            : this(HolidayBellNames[Utility.Random(HolidayBellNames.Length)])
        {
        }
        ...
        public override string DefaultName
        {
            get
            {
                return String.Format("A Holiday Bell From {0}", Giver);
            }
        }

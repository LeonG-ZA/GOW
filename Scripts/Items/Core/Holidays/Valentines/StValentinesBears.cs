...
namespace Server.Items
{
	public abstract class StValentinesBear : Item
	{
		...
		{
			if ( !CupidsArrow2012.CheckSeason( from ) || !CanSign )
				return;
            ...
            from.SendGump(new StValentinesBearGump(this));
		}
		...
		private class StValentinesBearGump : Gump
		{
			private StValentinesBear m_Bear;

            public StValentinesBearGump(StValentinesBear bear)
				: base( 50, 50 )
			{
				m_Bear = bear;

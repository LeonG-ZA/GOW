...
namespace Server.Items
{
    public class StuffyAnimal : Item
    {
        ...
        private DateTime m_LastClicked = DateTime.UtcNow - TimeSpan.FromSeconds(20); // To protect rampant clicking....
            ...
            : base()
        {
            ...
            Weight = 1.0;
            ItemID = m_StuffyID[m_Type];
            Hue = Utility.RandomList(506, 526, 546, 566, 586, 1153, 0);
        ...
        public override void OnDoubleClick(Mobile m)
        {
            ...
            else if (m_LastClicked > DateTime.UtcNow)
            {
                int waittime = (int)((m_LastClicked - DateTime.UtcNow).TotalSeconds) + 1;
        ...
        private static DateTime StuffyClicked(int Hue, Mobile m, int stuffy)
        {
            ...
            return (DateTime.UtcNow + TimeSpan.FromSeconds(59));
        }

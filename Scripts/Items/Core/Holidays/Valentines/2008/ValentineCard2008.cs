...
{
	public class ValentineCard2008 : Item
	{
		private static readonly int[] m_Names = new int[]
		{
            ...
            1079988, // Yew stole my heart ~1_target_player~. Signed: ~2_player~
            1079989, // Will you be mine, ~1_target_player~? Signed: ~2_player~
            1079990, // You've tamed my heart ~1_target_player~. Signed: ~2_player~
            1079991, // Happy Valentine's, ~1_target_player~! Signed: ~2_player~
            1079992, // You are too sweet ~1_target_player~. Signed: ~2_player~
            1079993, // Lady Melisande made me do it, ~1_target_player~. Signed: ~2_player~
		};
        ...
        {
            list.Add(m_TitleCliloc, string.Format("{0}\t{1}", m_ReceiverName ?? m_EmptyField, m_SenderName ?? m_EmptyField));
        }

        public ValentineCard2008(Serial serial)
			: base( serial )
		{
		}

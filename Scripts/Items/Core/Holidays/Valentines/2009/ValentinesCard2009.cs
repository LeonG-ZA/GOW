...
{
    public class ValentinesCard2009 : Item
    {
        ...
        private string m_To;
        [Constructable]
        public ValentinesCard2009(int itemid)
            : base(itemid)
        {
        ...
        public ValentinesCard2009(Serial serial)
            : base(serial)
        {
        }
    ...
    public class ValentinesCardSouth2009 : ValentinesCard2009
    {
        [Constructable]
        public ValentinesCardSouth2009()
            : base(0x0EBD)
        {
        }

        public ValentinesCardSouth2009(Serial serial)
            : base(serial)
        {
        }
    ...
    public class ValentinesCardEast2009 : ValentinesCard2009
    {
        [Constructable]
        public ValentinesCardEast2009()
            : base(0x0EBE)
        {
        }

        public ValentinesCardEast2009(Serial serial)
            : base(serial)
        {
        }

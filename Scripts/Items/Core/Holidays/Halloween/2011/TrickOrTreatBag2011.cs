...
{
	public class TrickOrTreatBag2011 : BaseContainer, IDyable
	{
		private int m_Uses;
		...
		[Constructable]
		public TrickOrTreatBag2011() : base( 0xE76 )
		{
			Weight = 2.0;
			Name = "Trick or Treat-2011";
			Hue = 43;
			
			Uses = 31;
			
			AddItem( new TrickOrTreatBook2011() );
		}

		public TrickOrTreatBag2011( Serial serial ) : base( serial )
		{
		}

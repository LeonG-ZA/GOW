...
namespace Server.Items
{
	...
	{
		private ChestTimer I_DeleteTimer;
		...
		{
			if( I_DeleteTimer == null )
				I_DeleteTimer = new ChestTimer( this );
			else
				I_DeleteTimer.Delay = TimeSpan.FromSeconds( Utility.Random( 1, 2 ));
		...
		{
			private BaseTreasureChestMod I_Chest;

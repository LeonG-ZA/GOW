...
namespace Server.Items
{
	public abstract class BaseExplosionPotion : BasePotion
	{
		...
		public void Explode(Mobile from, bool direct, Point3D loc, Map map)
		{
             ...
             */
            var eable = LeveledExplosion ? map.GetObjectsInRange(loc, ExplosionRange) : map.GetMobilesInRange(loc, ExplosionRange);
            ArrayList toExplode = new ArrayList();
			...
			for (int i = 0; i < toExplode.Count; ++i)
			{
				...
				if (o is Mobile)
				{
					...
					ItemAttributes.Damage(m, from, damage, 0, 100, 0, 0, 0);
				}

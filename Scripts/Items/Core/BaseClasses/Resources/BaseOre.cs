...
namespace Server.Items
{
    public abstract class BaseOre : Item
    {
        ...
        private class BaseOreTarget : Target
        {
            ...
            public BaseOreTarget(BaseOre ore) : base(2, false, TargetFlags.None)
            {
                this.m_Ore = ore;
            }
            ...
            private bool IsForge(object obj)
            {
                ...
                if (obj is BaseCreature)
                {
                    ...
                    if (!bc.IsDeadBondedPet && bc.Controlled && bc.ControlOrder == OrderType.Stay && bc is FireBeetle)
                        bodyID = ((Mobile)obj).Body;
                }
                ...
                return (itemID == 4017 || itemID == 11736 || (itemID >= 6522 && itemID <= 6569) || bodyID == 0xA9);
            }

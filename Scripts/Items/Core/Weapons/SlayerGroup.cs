...
namespace Server.Items
{
    public class SlayerGroup
    {
        ...
        static SlayerGroup()
        {
            ...
            if (Core.AOS)
            {
                abyss.Super = new SlayerEntry(SlayerName.Exorcism, typeof(DevourerOfSoulsRenowned), typeof(FireDaemonRenowned), typeof(AbysmalHorror), typeof(AbyssalInfernal), typeof(ArcaneDaemon), typeof(Balron), typeof(BoneDemon), typeof(ChaosDaemon), typeof(Daemon), typeof(SummonedDaemon), typeof(DemonKnight), typeof(Devourer), typeof(EnslavedGargoyle), typeof(FanDancer), typeof(FireGargoyle), typeof(Gargoyle), typeof(GargoyleDestroyer), typeof(GargoyleEnforcer), typeof(Gibberling), typeof(HordeMinion), typeof(IceFiend), typeof(Imp), typeof(Impaler), typeof(Moloch), typeof(Oni), typeof(Ravager), typeof(Semidar), typeof(StoneGargoyle), typeof(Succubus), typeof(TsukiWolf), /* Mondain's Legacy */ typeof(Szavetra), typeof(CrystalDaemon) /* End */, typeof(SlasherOfVeils), typeof(GargoyleShade), typeof(Putrefier));

...
namespace Server.Items
{
    ...
    public class SplinteringWeaponContext : PropertyEffect
    {
        ...
        {
            if (m.NetState != null && !AnimalForm.UnderTransformation(m, typeof(AnimalForm))
        ...
        public void DoBleed(Mobile m, Mobile from, int level)
        {
            if (m.Alive)
            {
                ...
                m.PlaySound(0x133);
                ItemAttributes.Damage(m, from, damage, false, 0, 0, 0, 0, 0, 0, 100, false, false, false);

...
namespace Server.Items
{
	...
	public class FrenziedWhirlwind : WeaponAbility
	{
		...
		public override void OnHit( Mobile attacker, Mobile defender, int damage )
		{
			...
			if( targets.Count > 0 )
			{
				...
				for( int i = 0; i < targets.Count; ++i )
				{
                    ...
                    t = new FrenziedWhirlwindTimer(attacker, m, amount);
					t.Start();
					Registry.Add( m, t );
				}
		...
		private class FrenziedWhirlwindTimer : Timer
		{
            ...
            public FrenziedWhirlwindTimer(Mobile attacker, Mobile defender, int totalDamage)

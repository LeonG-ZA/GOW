...
namespace Server.Items
{
	...
	public class Disarm : WeaponAbility
	{
        ...
        //public static readonly TimeSpan BlockEquipDurationSA = TimeSpan.FromSeconds(10.0);
        public static readonly TimeSpan BlockEquipDuration = (!Core.SA ? TimeSpan.FromSeconds(5.0) : TimeSpan.FromSeconds(10.0));
		...
		public override void OnHit( Mobile attacker, Mobile defender, int damage )
		{
            ...
            else if (CheckMana(attacker, true))
            {
                if (!IsImmune(defender))
                {
                    ...
                    //if (Core.SA)
                    //{
                     //   BuffInfo.AddBuff(defender, new BuffInfo(BuffIcon.NoRearm, 1075637, BlockEquipDurationSA, defender));

                     //   BaseWeapon.BlockEquip(defender, BlockEquipDurationSA);
                    //}
                    //else
                   // {

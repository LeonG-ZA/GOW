        ...
        public override void OnHit(Mobile attacker, Mobile defender, int damage)
        {
            ...
            switch( Utility.Random(5) )
            {
                case 0:
                    ...
                    break;
                case 1:
                    ItemAttributes.Damage(defender, attacker, amount, 0, 100, 0, 0, 0);
                    break;
                case 2:
                    ItemAttributes.Damage(defender, attacker, amount, 0, 0, 100, 0, 0);
                    break;
                case 3:
                    ItemAttributes.Damage(defender, attacker, amount, 0, 0, 0, 100, 0);
                    break;
                case 4:
                    ItemAttributes.Damage(defender, attacker, amount, 0, 0, 0, 0, 100);
                    break;
            }
        }
    }

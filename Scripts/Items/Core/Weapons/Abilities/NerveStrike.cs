...
namespace Server.Items
{
	...
	public class NerveStrike : WeaponAbility
	{
		...
		public override void OnHit( Mobile attacker, Mobile defender, int damage )
		{
			...
			//ItemAttributes.Damage( defender, attacker, (int)(15.0 * (attacker.Skills[SkillName.Bushido].Value - 50.0) / 70.0 + 10), 100, 0, 0, 0, 0 );	//10-25

            Server.Items.ParalyzingBlow.BeginImmunity(defender, TimeSpan.FromSeconds(10.0));

...
namespace Server.Items
{
	...
	public class TalonStrike : WeaponAbility
	{
        ...
        public override int BaseMana { get { return !Core.SA ? 30 : 20; } }
		...
		public override void OnHit( Mobile attacker, Mobile defender, int damage )
		{
			...
			Timer t = new TalonStrikeTimer( defender, (int)(10.0 * (attacker.Skills[SkillName.Ninjitsu].Value - 50.0) / 70.0 + 5), attacker );	//5 - 15 damage
		...
		private class TalonStrikeTimer : Timer
		{
            ...
            public TalonStrikeTimer(Mobile defender, int totalDamage, Mobile attacker)

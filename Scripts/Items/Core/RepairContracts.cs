...
namespace Server.Items
{
	...
	public class RepairContract : Item
	{
        ...
        public override void AddNameProperty(ObjectPropertyList list)
        {
            ...
            list.Add(1061133, String.Format("{0}\t{1}", level, title)); // A repair service contract from ~1_SKILL_TITLE~ ~2_SKILL_NAME~.
        }
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            this.LabelTo(from, 1061133, String.Format("{0}\t{1}", level, title)); // A repair service contract from ~1_SKILL_TITLE~ ~2_SKILL_NAME~.

            if (this.m_Crafter != null)
                this.LabelTo(from, 1050043, Crafter); // crafted by ~1_NAME~
        }

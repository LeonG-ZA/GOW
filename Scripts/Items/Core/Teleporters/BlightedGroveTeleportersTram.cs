...
{ 
    public class BlightedGroveTeleTram : Teleporter
    { 
        [Constructable]
        public BlightedGroveTeleTram()
            : base(new Point3D(6478, 863, 11), Map.Trammel)
        {
        }

        public BlightedGroveTeleTram(Serial serial)
            : base(serial)
        {
        }
    ...
    public class BlightedGroveTreeInTeleTram : Teleporter
    { 
        [Constructable]
        public BlightedGroveTreeInTeleTram()
            : base(new Point3D(6574, 889, 0), Map.Trammel)
        {
        }

        public BlightedGroveTreeInTeleTram(Serial serial)
            : base(serial)
        {
        }
    ...
    public class BlightedGroveTreeOutTeleTram : Teleporter
    { 
        [Constructable]
        public BlightedGroveTreeOutTeleTram()
            : base(new Point3D(6488, 849, 40), Map.Trammel)
        {
        }

        public BlightedGroveTreeOutTeleTram(Serial serial)
            : base(serial)
        {
        }

...
namespace Server.Items
{
	...
	public class MapleTreeDeed : BaseAddonDeed
	{
		...
		private class InternalGump : Gump
		{
			...
			private MapleTreeDeed m_Deed;

			public InternalGump( MapleTreeDeed deed )
				: base( 60, 36 )
			{
				m_Deed = deed;
				...
				AddHtmlLocalized( 44, 47, 213, 20, 1071104, 0x7FFF, false, false ); // Maple Tree
				AddButton( 19, 73, 0x845, 0x846, 101, GumpButtonType.Reply, 0 );
				AddHtmlLocalized( 44, 71, 213, 20, 1071301, 0x7FFF, false, false ); // Maple Tree (trunk)
			}

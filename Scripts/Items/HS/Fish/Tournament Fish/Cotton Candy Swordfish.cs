...
{
    public class CottonCandySwordfish : BaseHighSeasFish
    {
        ...
        [Constructable]
        public CottonCandySwordfish()
            : base(0x4304)
        {
        	Name = "cotton candy swordfish";
        	Hue = 2584;
                ...
                public override void GetProperties(ObjectPropertyList list)
        {
			...
			TimeSpan remaining = ( ( this.Created + Server.Items.CottonCandySwordfish.expire ) - DateTime.UtcNow );
			string display;
        ...
        public CottonCandySwordfish(Serial serial) : base(serial)
        {
        	Timer.DelayCall( TimeSpan.FromHours( 12.0 ), new TimerCallback( Expire ) );
        }

...
namespace Server.Items
{
	public class SBMessageTrigger : Item
	{
		...
		public override bool OnMoveOver( Mobile m )
		{
			...
			{
				/* The Serpent's Breath burns brighter than ever, blocking
				 * your escape! You shall have to venture further into the
				 * tomb in search of an exit. */
				m.SendLocalizedMessage( 1112225 );
			}

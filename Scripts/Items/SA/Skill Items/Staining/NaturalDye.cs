...
namespace Server.Items
{
    public class NaturalDye : Item, IDyeTub, IUsesRemaining
	{
        ...
        public static void DoCraft(Mobile from, CraftSystem system, Type typeRes, IUsesRemaining tool, CraftItem craftItem, PlantPigment pigments)
		{
		...
		private class PigmentsTarget : Target
		{
            ...
            public PigmentsTarget(CraftSystem system, Type typeRes, IUsesRemaining tool, CraftItem craftItem)

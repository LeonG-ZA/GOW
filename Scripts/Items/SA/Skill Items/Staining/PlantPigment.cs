...
namespace Server.Items
{
	public class PlantPigment : Item
	{
        ...
        public static void DoCraft(Mobile from, CraftSystem system, Type typeRes, IUsesRemaining tool, CraftItem craftItem, PlantClippings clippings)
		{
		...
		private class ClippingsTarget : Target
		{
            ...
            public ClippingsTarget(CraftSystem system, Type typeRes, IUsesRemaining tool, CraftItem craftItem)

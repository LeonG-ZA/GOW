...
{
	public class Standard_SoulForge : BaseAddon
	{
        public override BaseAddonDeed Deed { get { return new StandardSoulForgeDeed(); } }

		[Constructable]
		public Standard_SoulForge()
		{
        ...
        public Standard_SoulForge(Serial serial)
            : base(serial)
		{
		}
	...
	public class StandardSoulForgeDeed : BaseAddonDeed
	{
        public override BaseAddon Addon { get { return new Standard_SoulForge(); } }
		public override int LabelNumber{ get{ return 1031696; } }

		[Constructable]
		public StandardSoulForgeDeed()
		{
		}

        public StandardSoulForgeDeed(Serial serial)
            : base(serial)
		{
		}

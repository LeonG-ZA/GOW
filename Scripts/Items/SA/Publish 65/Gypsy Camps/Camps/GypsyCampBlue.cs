...
{
     public class GypsyCampBlue : BaseCamp
     {

         [Constructable]
         public GypsyCampBlue() : base( 0x70 )
         {
         }
         ...
         public override void AddComponents()
         {
             ...
             AddMobile(new Pub65Gypsy(), 15, 0, -2, 0);
             AddMobile(new Pub65Gypsy(), 15, 8, 8, 0);
             AddMobile(new Pub65Gypsy(), 15, -8, 8, 0);
             AddMobile(new Pub65Gypsy(), 15, -8, -8, 0);
             AddMobile(new Pub65Gypsy(), 15, 8, -8, 0);
             AddMobile(new Pub65Gypsy(), 15, 0, 7, 0);
         }

         public GypsyCampBlue( Serial serial ) : base( serial )
         {
         }

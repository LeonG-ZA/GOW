			...
			if ( m.Player )
			{
				if ( m_Maze.HasTrap( m.Location ) )
				{
					switch ( Utility.Random( 5 ) )
					{
						...
						case 0:
							{
								ItemAttributes.Damage( m, Utility.RandomMinMax( 70, 90 ), 0, 100, 0, 0, 0 );
						...
						case 1:
							{
								ItemAttributes.Damage( m, Utility.RandomMinMax( 60, 80 ), 0, 0, 100, 0, 0 );
						...
						case 2:
							{
								ItemAttributes.Damage( m, Utility.RandomMinMax( 55, 75 ), 0, 0, 0, 0, 100 );
						...
						case 4:
							{
								...
								ItemAttributes.Damage( m, Utility.RandomMinMax( 60, 80 ), 100, 0, 0, 0, 0 );
								...
								if ( Utility.RandomBool() )
								{
									...
									ItemAttributes.Damage( m, Utility.RandomMinMax( 40, 60 ), 100, 0, 0, 0, 0 );

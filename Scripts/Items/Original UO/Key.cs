    ...
    public class Key : Item
    {
        ...
        public override void GetProperties(ObjectPropertyList list)
        {
            ...
            if (Map != null)
            {
                ...
                if (map == Map.Trammel)
                    mDesc = "Location Trammel";
                if (map == Map.Felucca)
                    mDesc = "Location Felucca";
                if (map == Map.Ilshenar)
                    mDesc = "Location Ilshenar";
                if (map == Map.Malas)
                    mDesc = "Location Malas";
                if (map == Map.Tokuno)
                    mDesc = "Location Tokuno Islands";
                if (map == Map.TerMur)
                    mDesc = "Location: Ter Mur";
        ...
        private class UnlockTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (targeted == this.m_Key)
                {
                    ...
                    //from.SendGump(new RenamekeyGump(m_Key, from));

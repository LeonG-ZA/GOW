...
namespace Server.Items
{
	public class TreasureMap : MapItem
	{
        ...
        private static Type[][] m_IlshenarSpawns = new Type[][]
		{
			...
			new Type[]{ typeof( ExodusMinion ), typeof( GargoyleDestroyer ), typeof( Changeling ), typeof( EnslavedSatyr ), typeof( Titan ) },
            new Type[]{ typeof( ExodusMinion ), typeof( GargoyleDestroyer ), typeof( EnslavedSatyr ), typeof( Titan ), typeof( RenegadeChangeling ) }
		};
		...
		{
			new Type[]{ typeof( HeadlessOne ), typeof( Skeleton ) },
			new Type[]{ typeof( Mongbat ), typeof( Ratman ), typeof( HeadlessOne ), typeof( Skeleton ), typeof( Zombie ), typeof( ClockworkScorpion ), typeof( CorrosiveSlime ) },
			new Type[]{ typeof( AcidSlug ), typeof( Slith ), typeof( WaterElemental ) },
			new Type[]{ typeof( Kepetch ), typeof( BloodWorm ), typeof( StoneSlith ), typeof( ToxicSlith ) },
			new Type[]{ typeof( LeatherWolf ), typeof( StoneSlith ), typeof( ToxicSlith ), typeof( Raptor ), typeof( SilverSerpent ) },
			new Type[]{ typeof( LavaElemental ), typeof( FireAnt ), typeof( MaddeningHorror ) },
			new Type[]{ typeof( FireDaemon ), typeof( EnragedEarthElemental ), typeof( LavaElemental ), typeof( GreaterPoisonElemental ) },
            new Type[]{ typeof( FireDaemon ), typeof( EnragedEarthElemental ), typeof( LavaElemental ), typeof( GreaterPoisonElemental ) }
		};
		...
		public TreasureMap(int level, Map map)
		{
            if (FeaturesConfig.FeatHStreasureMapsEnabled)
            {
                ...
                if (level == 0)
                    ...
                    this.ChestLocation = GetRandomLocationHS(map);
        ...
        public static Point2D GetRandomLocationHS(Map t_map)
        {
            bool LandOk = true;
		...
		public static BaseCreature Spawn(int level, Point3D p, Map map, Mobile target, bool guardian)
		{
			...
			BaseCreature bc = Spawn(level, p, guardian);
		...
		public override void GetProperties(ObjectPropertyList list)
		{
            ...
            if (FeaturesConfig.FeatHStreasureMapsEnabled)
            {
                ...
                list.Add(mDesc); // for somewhere in Felucca : for somewhere in Trammel  etc...
        ...
        public virtual void Slice()
        {
            ...
            if (m_Decoder != null && Age >= 30)
            {
                ...
                m_Decoder = null;
                m_Found = DateTime.UtcNow;
                m_Location = GetRandomLocationHS(m_Map);
		...
		private class DigTimer : Timer
		{
			...
			protected override void OnTick()
			{
				...
				else if (m_Count > 10)
				{
					if (m_Chest == null)
					{
						m_Chest = new TreasureMapChest(m_From, m_TreasureMap.Level, true, null);

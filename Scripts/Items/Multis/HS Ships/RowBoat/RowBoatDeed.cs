...
namespace Server.Items
{
	...
	{
		private int m_MultiID_South, m_MultiID_East, m_MultiID_West, m_MultiID_North;
		...
		{
            from.CloseGump(typeof(RowBoatPlacementGump));

...
namespace Server.Items
{
    public abstract class BaseShipWeapon : BaseGalleonItem, IShipWeapon
    {
        ...
        private XmlBoatFight m_SiegeAttachment = null;
		...
		*/
        ...
        private XmlBoatFight SiegeAttachment
        {
            get
            {
                ...
                {
                    this.m_SiegeAttachment = (XmlBoatFight)XmlAttach.FindAttachment(this, typeof(XmlBoatFight));
                }
        ...
        {
            IShipProjectile projectile = this.m_Projectile as IShipProjectile;
            ...
            int distance = (int)XmlBoatFight.GetDistance(targetloc, this.Location);
        ...
        public virtual void LaunchProjectile(Mobile from, Item projectile, IEntity target, Point3D targetloc, TimeSpan delay)
        {
            ...
            XmlBoatFight.SendMovingProjectileEffect(this, target, animationid, this.ProjectileLaunchPoint, targetloc, 7, 0, false, true, animationhue);
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            from.Target = new ShipTarget(this, from, this.CheckLOS);
        }

...
using Server.HouseConfiguration;
...
namespace Server.Multis
{
    public abstract class BaseHouse : BaseMulti
    {
        ...
        public const int MaxCoOwners = HouseConfig.HouseMaxCoOwners;
        public static int MaxFriends { get { return HouseConfig.HouseMaxFriends; } }
        public static int MaxBans { get { return HouseConfig.HouseMaxBans; } }
        ...
        public const bool DecayEnabled = HouseConfig.HouseDecayEnabled;
        ...
        public virtual TimeSpan DecayPeriod { get { return HouseConfig.HouseDecayPeriod; } }
        ...
        public virtual DecayType DecayType
        {
            get
            {
                ...
                if (IsGameMaster( acct ))//acct.AccessLevel >= AccessLevel.GameMaster)
                {
                    return DecayType.Ageless;
                }
                /*
        ...
        private static bool IsGameMaster(Account acct)
        {
        ...
        public const int MaximumBarkeepCount = HouseConfig.HouseMaximumBarkeepCount;
        ...
        public BaseDoor AddEastInsideDoor(int x, int y, int z)
        {
            return this.AddEastInsideDoor(true, x, y, z);
        }

        public BaseDoor AddEastInsideDoor(bool wood, int x, int y, int z)
        {
        ...
        public BaseDoor AddSouthInsideDoor(int x, int y, int z)
        {
            return this.AddSouthInsideDoor(true, x, y, z);
        }

        public BaseDoor AddSouthInsideDoor(bool wood, int x, int y, int z)
        {
        ...
        public BaseDoor AddEastEntryDoor(int x, int y, int z, uint k)
        {
            return this.AddEastEntryDoor(true, x, y, z, k);
        }

        public BaseDoor AddEastEntryDoor(bool wood, int x, int y, int z, uint k)
        {
            BaseDoor door = this.MakeDoor(wood, DoorFacing.SouthCW);
        ...
        public BaseDoor AddSouthEntryDoor(int x, int y, int z, uint k)
        {
            return this.AddSouthEntryDoor(true, x, y, z, k);
        }

        public BaseDoor AddSouthEntryDoor(bool wood, int x, int y, int z, uint k)
        {
            BaseDoor door = this.MakeDoor(wood, DoorFacing.WestCW);
        ...
        public BaseDoor[] AddSouthEntryDoors(int x, int y, int z, uint k)
        {
            return this.AddSouthEntryDoors(true, x, y, z, k);
        }

        public BaseDoor[] AddSouthEntryDoors(bool wood, int x, int y, int z, uint k)
        {
            ...
            if (T2AConfig.T2AHouseDoorKeysEnabled)
            {
                eastDoor.KeyValue = m_keyvalue;
                westDoor.KeyValue = m_keyvalue;
            }
            else
            {
                westDoor.KeyValue = k;
        ...
        public uint CreateKeys(Mobile m)
        {
            ...
            if (T2AConfig.T2AHouseDoorKeysEnabled)
            {
                ...
                packKey.KeyValue = m_keyvalue;
                bankKey.KeyValue = m_keyvalue;

                packKey.Name = "a house key";
                bankKey.Name = "a house key";
        ...
        public BaseDoor[] AddSouthInsideDoors(int x, int y, int z)
        {
            return this.AddSouthInsideDoors(true, x, y, z, false);
        }

        public BaseDoor[] AddSouthInsideDoors(bool wood, int x, int y, int z, bool inv)
        {
...
//Check
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            foreach (RelocatedEntity relEntity in this.m_RelocatedEntities)
            {
                ...
                /*Added additional ientity.deleted impl.
        ...
        public static bool HasHouse(Mobile m)
        {
            ...
            for (int i = HouseConfig.HouseHousesMax; i < list.Count; ++i)
            {
                BaseHouse h = list[i];
        ...
        protected override void OnTarget(Mobile from, object targeted)
        {
            ...
            if (targeted is Item)
            {
                ...
                else
                {
                    ...
                    else if (targeted is DecorativeCarpet)
                    {
                        from.SendLocalizedMessage(1113269); // Decorative carpets may not be locked down in this manner...
                    }
                    else
                    {
                        #region Mondain's legacy

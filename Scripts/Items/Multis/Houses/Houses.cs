...
namespace Server.Multis
{
    public class SmallOldHouse : BaseHouse
    {
            ...
            : base(id, owner, 425, 3)
        {
            ...
            this.AddSouthEntryDoor(0, 3, 7, keyValue);
    ...
    public class GuildHouse : BaseHouse
    {
            ...
            : base(0x74, owner, 1100, 8)
        {
            ...
            this.AddSouthEntryDoors(-1, 6, 7, keyValue);

            this.SetSign(4, 8, 16);

            this.AddSouthInsideDoor(-3, -1, 7);
            this.AddSouthInsideDoor(3, -1, 7);
        }
    ...
    public class TwoStoryHouse : BaseHouse
    {
            ...
            : base(id, owner, 1370, 10)
        {
            ...
            this.AddSouthEntryDoors(-3, 6, 7, keyValue);

            this.SetSign(2, 8, 16);

            this.AddSouthInsideDoor(-3, 0, 7);
            this.AddSouthInsideDoor(id == 0x76 ? -2 : -3, 0, 27);
        }
    ...
    public class Tower : BaseHouse
    {
            ...
            : base(0x7A, owner, 2119, 15)
        {
            ...
            this.AddSouthEntryDoors(false, 0, 6, 6, keyValue);

            this.SetSign(5, 8, 16);

            this.AddSouthInsideDoor(false, 3, -2, 6);
            this.AddEastInsideDoor(false, 1, 4, 26);
            this.AddEastInsideDoor(false, 1, 4, 46);
        }
    ...
    public class Keep : BaseHouse//warning: ODD shape!
    {
            ...
            : base(0x7C, owner, 2625, 18)
        {
            ...
            this.AddSouthEntryDoors(false, 0, 10, 6, keyValue);
    ...
    public class Castle : BaseHouse
    {
            ...
            : base(0x7E, owner, 4076, 28)
        {
            ...
            this.AddSouthEntryDoors(false, 0, 15, 6, keyValue);

            this.SetSign(5, 17, 16);

            this.AddSouthInsideDoors(false, 0, 11, 6, true);
            this.AddSouthInsideDoors(false, 0, 5, 6, false);
            this.AddSouthInsideDoors(false, -1, -11, 6, false);
        }
    ...
    public class LargePatioHouse : BaseHouse
    {
            ...
            : base(0x8C, owner, 1100, 8)
        {
            ...
            this.AddSouthEntryDoors(-4, 6, 7, keyValue);
			
            this.SetSign(1, 8, 16);

            this.AddEastInsideDoor(1, 4, 7);
            this.AddEastInsideDoor(1, -4, 7);
            this.AddSouthInsideDoor(4, -1, 7);
        }
    ...
    public class LargeMarbleHouse : BaseHouse
    {
            ...
            : base(0x96, owner, 1370, 10)
        {
            ...
            this.AddSouthEntryDoors(false, -4, 3, 4, keyValue);
    ...
    public class SmallTower : BaseHouse
    {
            ...
            : base(0x98, owner, 580, 4)
        {
            ...
            this.AddSouthEntryDoor(false, 3, 3, 6, keyValue);
    ...
    public class LogCabin : BaseHouse
    {
            ...
            : base(0x9A, owner, 1100, 8)
        {
            ...
            this.AddSouthEntryDoor(1, 4, 8, keyValue);
			
            this.SetSign(5, 8, 20);

            this.AddSouthInsideDoor(1, 0, 29);
        }
    ...
    public class SandStonePatio : BaseHouse
    {
            ...
            : base(0x9C, owner, 850, 6)
        {
            ...
            this.AddSouthEntryDoor(-1, 3, 6, keyValue);
    ...
    public class TwoStoryVilla : BaseHouse
    {
            ...
            : base(0x9E, owner, 1100, 8)
        {
            ...
            this.AddSouthEntryDoors(3, 1, 5, keyValue);
			
            this.SetSign(3, 8, 24);

            this.AddEastInsideDoor(1, 0, 25);
            this.AddSouthInsideDoor(-3, -1, 25);
        }

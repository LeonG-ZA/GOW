...
{ 
    public class ClassicLizardmenCamp : BaseClassicCamp
    {
        public override ClassicCampType Camp { get { return ClassicCampType.Lizardman; } }

        [Constructable]
        public ClassicLizardmenCamp()
            : base(0x10EE)// dummy garbage at center
        {
        }

        public ClassicLizardmenCamp(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void AddComponents()
        {
            ...
            this.Visible = false;
            this.DecayDelay = TimeSpan.FromMinutes(30.0);//5
            ...
            {
                case 0:
                    this.Prisoner = new ClassicNoble(this);
                    break;
                default:
                    this.Prisoner = new ClassicSeekerOfAdventure(this);
                    break;
            }
			
            //be = (BaseEscortable)Prisoner;
            //be.m_Captive = true;
			
            bc = (BaseCreature)this.Prisoner;
            bc.IsPrisoner = true;
            bc.CantWalk = true;
			
            this.Prisoner.YellHue = Utility.RandomList(0x57, 0x67, 0x77, 0x87, 0x117);
            this.AddMobile(this.Prisoner, 2, Utility.RandomMinMax(-2, 2), Utility.RandomMinMax(-2, 2), 0);
        }

        // Don't refresh decay timer
        public override void OnEnter(Mobile m)
        {
            if (m.Player && this.Prisoner != null && this.Prisoner.CantWalk)
            {
                int number;
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            switch ( version )
            {
                case 0:
                    {
                        this.Prisoner = reader.ReadMobile();
                        break;
                    }
            }
        }
        ...
        private void AddCampChests()
        {
            ...
            TreasureMapChest.Fill(chest, 1, null);

...
{ 
    public class ClassicOrcCamp : BaseClassicCamp
    {
	
	    //public virtual Mobile Orcs{ get{ return new Orc(); } }
		public override ClassicCampType Camp { get { return ClassicCampType.Orc; } }
        //private Mobile m_Prisoner;
        [Constructable]
        public ClassicOrcCamp()
            : base(0x10EE)// dummy garbage at center
        {
        }

        public ClassicOrcCamp(Serial serial)
            : base(serial)
        {
        }

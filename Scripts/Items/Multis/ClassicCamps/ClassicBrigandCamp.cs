...
{ 
    public class ClassicBrigandCamp : BaseClassicCamp
    {
        public override ClassicCampType Camp { get { return ClassicCampType.Brigand; } }

        [Constructable]
        public ClassicBrigandCamp()
            : base(0x10EE)// dummy garbage at center
        {
        }

        public ClassicBrigandCamp(Serial serial)
            : base(serial)
        {
        }

...
{ 
    public class ClassicRatCamp : BaseClassicCamp
    {
        public override ClassicCampType Camp { get { return ClassicCampType.Ratman; } }

        [Constructable]
        public ClassicRatCamp()
            : base(0x10EE)// dummy garbage at center
        {
        }

        public ClassicRatCamp(Serial serial)
            : base(serial)
        {
        }

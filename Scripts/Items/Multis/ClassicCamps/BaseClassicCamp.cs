...
namespace Server.Multis
{
    ...
    public abstract class BaseClassicCamp : BaseMulti
    {
        ...
        private ClassicCampType m_Camp;
        #endregion
        public BaseClassicCamp(int multiID)
            : base(multiID)
        {
            ...
            #region BBS Quests
            m_Camp = ClassicCampType.Default;
            #endregion

            Timer.DelayCall(TimeSpan.Zero, new TimerCallback(CheckAddComponents));
        }

        public BaseClassicCamp(Serial serial)
            : base(serial)
        {
        }
        ...
        public virtual ClassicCampType Camp { get { return m_Camp; } set { m_Camp = value; } }
        ...
        public virtual TimeSpan DecayDelay
        {
            ...
            set
            {
                ...
                this.RefreshDecay(true);
                this.m_Camp = ClassicCampType.Default;
            }
        }
                ...
                case 1:
                    {
                        ...
                        m_Camp = (ClassicCampType)reader.ReadInt();
                        goto case 0;
                    }
                case 0:
                    {
    ...
    public class ClassicLockableBarrel : LockableContainer
    {
        [Constructable]
        public ClassicLockableBarrel()
            : base(0xE77)
        {
            this.Weight = 1.0;
        }

        public ClassicLockableBarrel(Serial serial)
            : base(serial)
        {
        }

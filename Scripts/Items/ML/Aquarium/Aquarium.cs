    ...
    public class Aquarium : BaseAddonContainer
    {
        ...
        public int DeadCreatures
        {
            get
            {
                ...
                {
                    if (this.Items[i] is BaseAquariumFish)
                    {
                        BaseAquariumFish fish = (BaseAquariumFish)this.Items[i];
        ...
        private void RecountLiveCreatures()
        {
            ...
            List<BaseAquariumFish> fish = this.FindItemsByType<BaseAquariumFish>();

    ...
    public class GreenThorns : Item
    {
        ...
        private class InternalTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                {
                    from.LocalOverheadMessage(MessageType.Regular, 0x2B2, 1080037);// No solen lairs exist on this facet.  Try again in Trammel or Felucca.
                    return;
                }
                ...
                else if (from.Region.IsPartOf(typeof(ChampionSpawnRegion)) && ValidateSand(from.Map, from.X, from.Y))
                {
                    from.LocalOverheadMessage(MessageType.Regular, 0x3B2, 1061912); // * You cannot plant a green thorn there! *
                }
                else

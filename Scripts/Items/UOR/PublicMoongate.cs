...
namespace Server.Items
{
    public class PublicMoongate : Item
    {
        ...
        public static void MoonGen_OnCommand(CommandEventArgs e)
        {
            ...
            int count = 0;
            if (MainConfig.MainTrammelGenEnabled)
            {
                count += MoonGen(PMList.Trammel);
            }
            if (MainConfig.MainFeluccaGenEnabled)
            {
                count += MoonGen(PMList.Felucca);
            }
            if (MainConfig.MainIlshenarGenEnabled)
            {
                count += MoonGen(PMList.Ilshenar);
            }
            if (MainConfig.MainMalasGenEnabled)
            {
                count += MoonGen(PMList.Malas);
            }
            if (MainConfig.MainTokunoGenEnabled)
            {
                count += MoonGen(PMList.Tokuno);
            }
            if (MainConfig.MainTerMurGenEnabled)
            {
    ...
    public class PMList
    {
        ...
        public static readonly PMList TerMur = new PMList(1113602, 1113602, Map.TerMur, new PMEntry[]
			{
        ...
        public static readonly PMList[] FeluccaOnlyList = new PMList[] { Felucca };
            ...
            : base(100, 100)
        {
            ...
            if (mobile.Player)
            {
                ...
                else
                {
                    ...
                    {
                        if (MainConfig.MainFeluccaOnlyEnabled)
                        {
                            checkLists = PMList.FeluccaOnlyList;
                        }
                        else
                        {
                            checkLists = checkLists = young ? PMList.SAListsYoung : PMList.SALists;
                        }
                    }

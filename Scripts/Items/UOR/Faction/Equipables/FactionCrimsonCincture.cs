...
{
	//[Alterable( typeof( DefTailoring ), typeof( GargishFactionCrimsonCincture ) )]
	public class FactionCrimsonCincture : HalfApron, IFactionArtifact
	{
		...
		public FactionCrimsonCincture( Serial serial )
			: base( serial )
		{
		}

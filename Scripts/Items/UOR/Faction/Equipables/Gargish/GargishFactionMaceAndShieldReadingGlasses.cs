...
{
	public class GargishFactionMaceAndShieldReadingGlasses : GargishGlasses, IFactionArtifact
	{
		...
		[Constructable]
		public GargishFactionMaceAndShieldReadingGlasses()
			: base()
		{
			Hue = 477;
		...
		public GargishFactionMaceAndShieldReadingGlasses( Serial serial )
			: base( serial )
		{
		}

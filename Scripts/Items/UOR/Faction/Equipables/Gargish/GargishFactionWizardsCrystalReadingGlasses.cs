...
{
	public class GargishFactionWizardsCrystalReadingGlasses : GargishGlasses, IFactionArtifact
	{
		...
		[Constructable]
		public GargishFactionWizardsCrystalReadingGlasses()
			: base()
		{
			Hue = 557;
		...
		public GargishFactionWizardsCrystalReadingGlasses( Serial serial )
			: base( serial )
		{
		}

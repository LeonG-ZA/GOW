...
namespace Server.Accounting
{
	...
	{
        public static readonly TimeSpan YoungDuration = AccountConfig.AccountYoungDuration;
        public static readonly TimeSpan InactiveDuration = AccountConfig.AccountInactiveDuration;
        public static readonly TimeSpan EmptyInactiveDuration = AccountConfig.AccountEmptyInactiveDuration;
        public static bool m_Trial = false;
		...
		public string[] IPRestrictions
		{
			get
			{
				return m_IPRestrictions;
			}
			set
			{
				m_IPRestrictions = value;
			}
		}
		/// <summary>
        ...
        /// <summary>
        /// Gets or sets a flag indicating if the account has trial access level.
        /// </summary>
        [CommandProperty(AccessLevel.Administrator)]
        public bool Trial
        {
            get
            {
                // Implement here your logic for trial accounts. By default, all accounts have full level access.
                return m_Trial;
            }
        }
		...
		private static void EventSink_Disconnected(DisconnectedEventArgs e)
		{
            ...
            {
                string msg = " Has logged off of " + m.Name + ".";
                try
                {
                    ...
                    using (StreamWriter sw = new StreamWriter(path, true))
                        sw.WriteLine("{0}: {1}", DateTime.UtcNow, msg);
                }
                catch
                {
                }

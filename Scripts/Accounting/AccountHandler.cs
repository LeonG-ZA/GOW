...
namespace Server.Misc
{
    ...
    public class AccountHandler
    {
        ...
        private static readonly int MaxAccountsPerIP = AccountConfig.AccountMaxAccountsPerIP;
        private static readonly bool AutoAccountCreation = AccountConfig.AccountAutoAccountCreation;

        private static readonly TimeSpan DeleteDelay = AccountConfig.AccountDeleteDelay;

        private static bool m_RestrictCharacterDeletion = AccountConfig.AccountRestrictCharacterDeletion;
        ...
        */
        ...
        public static void EventSink_AccountLogin(AccountLoginEventArgs e)
        {
            if (!IPLimiter.SocketBlock && !IPLimiter.Verify(e.State.Address))
            {
                ...
                using (StreamWriter op = new StreamWriter(LogConfig.LogIpLimits, true))

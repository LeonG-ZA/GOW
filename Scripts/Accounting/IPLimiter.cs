...
namespace Server.Misc
{
    ...
    {
        public static bool Enabled = AccountConfig.AccountIPLimiterEnabled;
        public static bool SocketBlock = AccountConfig.AccountSocketBlock;// true to block at connection, false to block at login request
        public static int MaxAddresses = AccountConfig.AccountMaxAddresses;

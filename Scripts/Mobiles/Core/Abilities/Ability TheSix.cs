    ...
    public partial class Ability
    {
        ...
        public class SimpleFlameTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                ...
                { // It looked like it delt 67 damage, presuming 70% fire res thats about 223 damage delt before resistance.                                          
                    ItemAttributes.Damage(this.m_Target, this.m_From, Utility.RandomMinMax(210, 230), 0, 100, 0, 0, 0); 
        ...
        internal class FlameWaveTimer : Timer
        {
            ...
            public void Hurt(object o)
            {
                ...
                ItemAttributes.Damage(m, this.m_From, damage, 0, 100, 0, 0, 0);
        ...
        public class FireField : Item
        {
            ...
            {
                if (m != this.m_Owner)
                    ItemAttributes.Damage(m, (this.m_Owner == null) ? m : this.m_Owner, Utility.RandomMinMax(this.m_MinDamage, this.m_MaxDamage), 0, 100, 0, 0, 0);
            }

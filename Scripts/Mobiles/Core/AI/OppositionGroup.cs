...
namespace Server
{
    public class OppositionGroup
    {
        ...
        /*
        private static readonly OppositionGroup m_ExodusAndDupres = new OppositionGroup(new Type[][]
        {
            new Type[]
            {
                typeof(DupresChampion),
                typeof(DupresSquire),
                typeof(DupresKnight)
            },
            new Type[]
            {
                typeof(ExodusDrone),
                typeof(ExodusJuggernaut),
                typeof(ExodusMinionLord),
                typeof(ExodusMinion),
                typeof(ExodusSentinel),
				typeof(ExodusZealot)
            }
        });
         */
        ...
        //public static OppositionGroup ExodusAndDupres
        //{
           // get
           // {
              //  return m_ExodusAndDupres;
            //}
        //}

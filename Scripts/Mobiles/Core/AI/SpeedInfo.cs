        ...
        private static readonly SpeedInfo[] m_Speeds = new SpeedInfo[]
        {
          /* Slow */
            ...
            new SpeedInfo(0.2, 0.4, new Type[]
            {
                ...
                typeof(Changeling),        typeof(LadyJennifyr),        typeof(LadyMarai),
                typeof(MasterJonath),      typeof(MasterMikael),        typeof(MasterTheophilus),
                typeof(RedDeath),          typeof(SirPatrick),          typeof(Miasma),
                typeof(Rend),              typeof(Grobu),               typeof(Gnaw),
                typeof(Guile),             typeof(Irk),                 typeof(Spite),
                typeof(LadyLissith),       typeof(LadySabrix),          typeof(Malefic),
                typeof(Silk),              typeof(Virulent),            typeof( SentinelSpider )
            ...
            new SpeedInfo(0.175, 0.350, new Type[]
            {
                ...
                typeof( NavreyNightEyes ), typeof( Raptor ),			typeof( TrapdoorSpider )
            }),
            /* Medium */
            new SpeedInfo(0.25, 0.5, new Type[]
            {
                typeof(AcidElemental),    typeof(AgapiteElemental),    typeof(Alligator),
                typeof(AncientLich),       typeof(Betrayer),            typeof(BlackSolenInfiltratorQueen),
                typeof(BlackBear),         typeof(Bird),                typeof(BlackSolenInfiltratorWarrior),

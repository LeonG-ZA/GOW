...
namespace Server.Mobiles
{
    public class MageAI : BaseAI
    {
        ...
        public virtual Spell GetRandomBlessSpell()
        {
            bool hasStrBuff = m_Mobile.GetStatMod("[Magic] Str Bonus") != null;
            bool hasDexBuff = m_Mobile.GetStatMod("[Magic] Dex Bonus") != null;
            bool hasIntBuff = m_Mobile.GetStatMod("[Magic] Int Bonus") != null;

            if ((!hasStrBuff || !hasDexBuff || !hasIntBuff) && Utility.RandomBool())
            {
            ...
            {
                default:
                case 0: if (!hasStrBuff) return new StrengthSpell(m_Mobile, null); break;
                case 1: if (!hasDexBuff) return new AgilitySpell(m_Mobile, null); break;
                case 2: if (!hasIntBuff) return new CunningSpell(m_Mobile, null); break;
            }
        ...
        public Spell CheckCastHealingSpell()
        {
            ...
            Spell spell = GetRandomHealingSpell();
        ...
        public virtual bool ProcessTarget()
        {
            ...
            bool isDispel = (targ is DispelSpell.DispelSpellTarget);
            bool isParalyze = (targ is ParalyzeSpell.ParalyzeSpellarget);
            bool isTeleport = (targ is TeleportSpell.TeleportSpellTarget);
            bool isInvisible = (targ is InvisibilitySpell.InvisibilitySpellTarget);

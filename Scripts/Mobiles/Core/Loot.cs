...
namespace Server
{
    public class Loot
    {
        ...
        private static readonly Type[] m_MysticRegTypes = new[]
			{
				...
				typeof( FertileDirt ),			typeof( DragonBlood ),			typeof( DaemonBone )
			};
	    ...
	    {
				typeof( EssenceBalance ),		typeof( EssenceAchievement ),		typeof( EssencePassion ),
				typeof( EssencePrecision ),	    typeof( EssenceDirection ),		    typeof( EssenceDiligence ),
				typeof( EssenceFeeling ),		typeof( EssenceControl ),			typeof( EssenceSingularity ),
				typeof( EssenceOrder ),		    typeof( EssencePersistence ),
	    };
        ...
        public static BaseSpellScroll RandomScroll(int minIndex, int maxIndex, SpellbookType type)
        {
            Type[] types;
            ...
            return Construct(types, Utility.RandomMinMax(minIndex, maxIndex)) as BaseSpellScroll;
        }

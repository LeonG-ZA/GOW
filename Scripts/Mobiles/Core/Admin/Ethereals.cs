...
namespace Server.Mobiles
{
	public class EtherealMount : Item, IMount, IMountItem, IRewardItem
	{
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public bool SolidHue
        {
            get { return m_SolidHue; }
            set { m_SolidHue = value; InvalidateProperties(); }
        }
        ...
        public virtual int EtherealHue { get { return SolidHue ? 0 : 0x4001; } }
    ...
    public class EtherealAncientHellHound : EtherealMount
    {
        ...
        public override int LabelNumber { get { return 1155724; } } // Ridable Ancient Hell Hound Statuette
        public override void Serialize(GenericWriter writer)
        {
            base.Serialize(writer);

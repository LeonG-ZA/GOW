...
{
    public class BaseClassicEscortable : BaseCreature
    {
        ...
        private static readonly TimeSpan m_EscortDelay = NpcConfig.NpcClassicEscortDelay;
        private EDI m_Destination;
        private string m_DestinationString;
        private DateTime m_DeleteTime;
        private Timer m_DeleteTimer;
        #region BBS Quests
        private ClassicBulletinMessage m_Message;
        public ClassicBulletinMessage Message { get; set; }

        private BaseClassicCamp m_Camp;
        public BaseClassicCamp Camp { get; set; }
        #endregion
        private DateTime m_LastSeenEscorter;
      
        #region BBS Quest
        [Constructable]
        public BaseClassicEscortable()
            : this(null)
        {
        }

        public BaseClassicEscortable(BaseClassicCamp camp)
        ...
        public BaseClassicEscortable(Serial serial)
            : base(serial)
        {
        }
        ...
        public virtual bool AcceptEscorter(Mobile m)
        {
            ...
            BaseClassicEscortable escortable = (BaseClassicEscortable)m_EscortTable[m];
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            #region BBS Quests
            //this.m_Message = reader.ReadItem() as EscortMessage;
            this.m_Message = reader.ReadItem() as ClassicBulletinMessage;
            #endregion
        }
        ...
        public override void AddCustomContextEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            if (dest != null && from.Alive)
            {
                ...
                if (escorter == null || escorter == from)
                    list.Add(new ClassicAskDestinationEntry(this, from));

                if (escorter == null)
                    list.Add(new ClassicAcceptEscortEntry(this, from));
                else if (escorter == from)
                    list.Add(new ClassicAbandonEscortEntry(this, from));
            }
          ...
          protected override void OnLocationChange(Point3D oldLocation)
        {
            ...
            if (oldLocation == Point3D.Zero)
            {
                ...
                {
                    if (m_Camp != null)
                        m_Message = new ClassicPrisonerMessage(m_Camp, this);
                    else
    ...
    public class ClassicEscortDestinationInfo
    {
        private static Hashtable m_Table;
        private readonly string m_Name;
        private readonly Region m_Region;
        //private Rectangle2D[] m_Bounds;
        public ClassicEscortDestinationInfo(string name, Region region)
        {
            this.m_Name = name;
        ...
        public static void LoadTable()
        {
            ...
            foreach (Region r in list)
            {
                ...
                if (r is Regions.DungeonRegion || r is Regions.TownRegion)
                    m_Table[r.Name] = new ClassicEscortDestinationInfo(r.Name, r);
            }
        }
        ...
        public static EDI Find(string name)
        {
            ...
            return (ClassicEscortDestinationInfo)m_Table[name];
        }
    ...
    public class ClassicAskDestinationEntry : ContextMenuEntry
    {
        private readonly BaseClassicEscortable m_Mobile;
        private readonly Mobile m_From;
        public ClassicAskDestinationEntry(BaseClassicEscortable m, Mobile from)
            : base(6100, 3)
        {
            this.m_Mobile = m;
            this.m_From = from;
    ...
    public class ClassicAcceptEscortEntry : ContextMenuEntry
    {
        private readonly BaseClassicEscortable m_Mobile;
        private readonly Mobile m_From;
        public ClassicAcceptEscortEntry(BaseClassicEscortable m, Mobile from)
            : base(6101, 3)
        {
            this.m_Mobile = m;
            this.m_From = from;
    ...
    public class ClassicAbandonEscortEntry : ContextMenuEntry
    {
        private readonly BaseClassicEscortable m_Mobile;
        private readonly Mobile m_From;
        public ClassicAbandonEscortEntry(BaseClassicEscortable m, Mobile from)
            : base(6102, 3)
        {
            this.m_Mobile = m;
            this.m_From = from;

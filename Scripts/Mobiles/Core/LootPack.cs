...
namespace Server
{
    public class LootPack
    {
        ...
        public static readonly LootPack HighScrolls = new LootPack(new[] { new LootPackEntry(false, HighScrollItems, 100.00, 1) });

        public static readonly LootPack Gems = new LootPack(new[] { new LootPackEntry(false, GemItems, 100.00, 1) });

        public static readonly LootPack RareGems = new LootPack(new[] { new LootPackEntry(false, RareGemItems, 100.00, 1) });

        public static readonly LootPack Potions = new LootPack(new[] { new LootPackEntry(false, PotionItems, 100.00, 1) });

        public static readonly LootPack PeerlessIngredients = new LootPack(new[] { new LootPackEntry(false, PeerlessIngredientsItems, 100.00, 1) });

        public static readonly LootPack CavernIngredients = new LootPack(new[] { new LootPackEntry(false, CavernIngredientsItems, 100.00, 1) });

        #region Mondain's Legacy
        public static readonly LootPackItem[] ParrotItem = new[] { new LootPackItem(typeof(PetParrot), 1) };

...
namespace Server.Mobiles
{
    ...
    {
        public static double ChestChance = NpcConfig.NpcChestParagonChance;
        public static double ChocolateIngredientChance = NpcConfig.NpcParagonChocolateIngredientChance;
        ...
        public static int Hue = NpcConfig.NpcParagonHue;
        ...
        public static bool CheckConvert(BaseCreature bc, Point3D location, Map m)
        {
            ...
            if (bc is BaseChampion || bc is Harrower || bc is BaseVendor || bc is BaseEscortable || bc.Summoned || bc.Controlled || bc is Clone || bc.IsParagon)
                return false;

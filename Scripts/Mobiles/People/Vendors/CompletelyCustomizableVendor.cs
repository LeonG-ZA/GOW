...
namespace System.CustomizableVendor
{
    ...
    public class ManageItemsGump : JewlRewardGump
    {
        ...
        protected override void AddEntryControl(Reward r)
        {
            ...
            //odd numbers
            AddButtonTileArt(227, (PosY + 26), 2328, 2329, GumpButtonType.Reply, ++m_ButtonNum, PageNum, b.ItemID, b.Hue, 15, 10, r.Display.Header);
    ...
    public class JewlRewardGump : Gump, IRewardVendorGump
    {
        ...
        protected virtual void AddEntryControl(Reward r)
        {
            ...
            AddButtonTileArt(227, (m_PosY + 26), 2328, 2329, GumpButtonType.Reply, (m_EntryNum), m_PageNum, b.ItemID, b.Hue, 15, 10, b.LocalizedTooltip);

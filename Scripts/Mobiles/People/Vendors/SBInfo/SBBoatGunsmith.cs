    ...
    public class SBBoatGunsmith : SBInfo
    {
        ...
        public class InternalBuyInfo : List<GenericBuyInfo>
        {
            public InternalBuyInfo()
            {
                ...
                this.Add(new GenericBuyInfo("1041206", typeof(HeavyShipCannonball), 1000, 20, 0xE74, 0));
                ...
                this.Add(new GenericBuyInfo("1041209", typeof(LightShipGrapeShot), 1000, 20, 0xE74, 0));
                this.Add(new GenericBuyInfo("1041209", typeof(HeavyShipGrapeShot), 1000, 20, 0xE74, 0));

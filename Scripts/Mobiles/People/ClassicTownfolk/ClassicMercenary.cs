...
{
    public class ClassicMercenary : BaseCreature
    {
        [Constructable]
        public ClassicMercenary()
        ...
        public ClassicMercenary(Serial serial)
            : base(serial)
        {
        }
    ...
    public class ClassicMercenaryCorpse : Corpse
    {
        public ClassicMercenaryCorpse(Mobile owner, HairInfo hair, FacialHairInfo facialhair, List<Item> equipItems)
            : base(owner, hair, facialhair, equipItems)
        {
        }

        public ClassicMercenaryCorpse(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void AddNameProperty(ObjectPropertyList list)
        {
            if (this.ItemID == 0x2006) // Corpse form
            {
                ...
                list.Add(1049318, this.Name); // the remains of ~1_NAME~ the ClassicMercenary
            }
            else
            {

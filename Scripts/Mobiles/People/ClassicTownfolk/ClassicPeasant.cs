...
{
    public class ClassicPeasant : BaseClassicEscortable
    {
        ...
        private static readonly string[] m_MLTownNames = new string[]
        {
            ...
            /*ClassicPeasant not likely to explore regions
        ...
        [Constructable]
        public ClassicPeasant()
        {
            this.Title = "the Peasant";
        }

        public ClassicPeasant(Serial serial)
            : base(serial)
        {
        }
        ...
        }// Do not display 'the ClassicPeasant' when single-clicking

...
{
    public class ClassicMerchant : BaseClassicEscortable
    {
        ...
        public ClassicMerchant(Serial serial)
            : base(serial)
        {
        }
        ...
        }// Do not display 'the ClassicMerchant' when single-clicking

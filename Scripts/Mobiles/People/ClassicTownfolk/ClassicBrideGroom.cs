/*Change to Old School ClassicBrideGroom if bride on death she drops silver sandals
...
{
    public class ClassicBrideGroom : BaseClassicEscortable
    {
        ...
        public ClassicBrideGroom(Serial serial)
            : base(serial)
        {
        }

...
{
    public class ClassicSeekerOfAdventure : BaseClassicEscortable
    {
        ...
        #region BBS Quests
        [Constructable]
        public ClassicSeekerOfAdventure()
            : this(null)
        {
        }

        public ClassicSeekerOfAdventure(BaseClassicCamp c)
            : base(c)
        {
        #endregion
        ...
        public ClassicSeekerOfAdventure(Serial serial)
            : base(serial)
        {
        }

...
namespace Server.Mobiles
{
    ...
    public class QuartzElementalGuardian : BaseCreature
    {
        ...
        [Constructable]
        public QuartzElementalGuardian(ShameAltarAddon altar)
        ...
        public override void OnThink()
        {
            if (DateTime.UtcNow > m_DecayTime)
            {
                ...
                {
                    m.SendMessage("You have failed to defeat the Guardian");//You failed to defeat the champion in time. 1151628
                }
        ...
        public QuartzElementalGuardian(Serial serial)
            : base(serial)
        {
        }

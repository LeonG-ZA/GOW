...
{
	public class BouraBouraQuest : TieredQuest
	{
		public override QuestTier Tier { get { return QuestTier.PercolemTier1; } }
		...
		{
			AddObjective( new SlayObjective( typeof( RuddyBoura ), "ruddy boura", 20 ) );
			AddObjective( new SlayObjective( typeof( LowlandBoura ), "louland boura", 15 ) );

			AddReward( new BaseReward( typeof( DustyAdventurerBackpack ), 1113189 ) ); // Dusty Adventurer's Backpack
		}
	...
	public class RaptorliciousQuest : TieredQuest
	{
		public override QuestTier Tier { get { return QuestTier.PercolemTier1; } }
	...
	public class TheSlithWarsQuest : TieredQuest
	{
		public override QuestTier Tier { get { return QuestTier.PercolemTier1; } }
	...
	public class BouraBouraAndMoreBouraQuest : TieredQuest
	{
		public override QuestTier Tier { get { return QuestTier.PercolemTier2; } }
		...
		public BouraBouraAndMoreBouraQuest()
		{
			...
			AddReward( new BaseReward( typeof( DustyExplorerBackpack ), 1113190 ) ); // Dusty Explorer's Backpack
		}
	...
	public class RevengeOfTheSlithQuest : TieredQuest
	{
		public override QuestTier Tier { get { return QuestTier.PercolemTier2; } }
		...
		{
			AddObjective( new SlayObjective( typeof( ToxicSlith ), "toxic slith", 20 ) );
	...
	public class WeveGotAnAntProblemQuest : TieredQuest
	{
		public override QuestTier Tier { get { return QuestTier.PercolemTier2; } }
	...
	public class AmbushingTheAmbushersQuest : TieredQuest
	{
		public override QuestTier Tier { get { return QuestTier.PercolemTier2; } }
		...
		{
			AddObjective( new SlayObjective( typeof( KepetchAmbusher ), "kepetch ambusher", 20 ) );
	...
	public class ItMakesMeSickQuest : TieredQuest
	{
		public override QuestTier Tier { get { return QuestTier.PercolemTier3; } }
		...
		public ItMakesMeSickQuest()
		{
			...
			AddReward( new BaseReward( typeof( DustyHunterBackpack ), 1113191 ) ); // Dusty Hunter's Backpack
		}
	...
	public class ItsAMadMadWorldQuest : TieredQuest
	{
		public override QuestTier Tier { get { return QuestTier.PercolemTier3; } }
		...
		{
			AddObjective( new SlayObjective( typeof( MaddeningHorror ), "maddening horror", 20 ) );
	...
	public class TheDreamersQuest : TieredQuest
	{
		public override QuestTier Tier { get { return QuestTier.PercolemTier3; } }
		...
		{
			AddObjective( new SlayObjective( typeof( DreamWraith ), "dream wraith", 20 ) );

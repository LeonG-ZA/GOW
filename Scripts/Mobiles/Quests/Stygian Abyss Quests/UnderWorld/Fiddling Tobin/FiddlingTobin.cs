...
namespace Server.Engines.Quests
{
	public class DoneInTheNameOfTinkering : BaseQuest
	{
		...
		{
			AddObjective( new ObtainObjective( typeof( FloorTrapComponents ), "Floor Trap Components", 5 ) );

			AddReward( new BaseReward( typeof( FloorTrapKit ), 5, 1113293 ) ); // Floor Trap Kit
		}

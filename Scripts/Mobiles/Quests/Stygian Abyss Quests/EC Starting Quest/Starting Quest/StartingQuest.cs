...
namespace Server
{
	public class KRStartingQuest
	{
		...
		private static void GenQuest_Command( CommandEventArgs e )
		{
            ...
            spawner = new CreatureSpawner("Hogarth", 1, 300, 600, 0, 0);
		...
		{
            if (QuestConfig.KRStartingQuestEnabled)
            {
                switch (pm.KRStartingQuestStep)
                {
                    case 0:
                        {
                            ...
                            pm.KRStartingQuestStep = 32;
                            break;
                        }
                    case 1:
                        {
                            if (pm.KRStartingQuestStep == 32)
                            {
                                break;
                            }
                            else
                    ...
                    case 2:
                        {
                            ...
                            pm.Send(new KRDisplayWaypoint(Serial.MinusOne, new Point3D(3648, 2674, 0), Map.Trammel, WaypointType.QuestDestination, true, 1078266)); // Walk Toward Here
                    ...
                    case 3:
                        {
                            ...
                            pm.Send(new KRDisplayWaypoint(Serial.MinusOne, new Point3D(3648, 2666, 0), Map.Trammel, WaypointType.QuestDestination, true, 1078267)); // Run Toward Here
                    ...
                    case 4:
                        {
                            ...
                            pm.Send(new KRDisplayWaypoint(Serial.MinusOne, new Point3D(3648, 2655, 0), Map.Trammel, WaypointType.QuestDestination, true, 1078268)); // Pathfind Toward Here
                    ...
                    case 8:
                        {
                            pm.Send(new KRDisplayWaypoint(Serial.MinusOne, new Point3D(3672, 2653, 0), Map.Trammel, WaypointType.QuestDestination, true, 1078266)); // Walk Toward Here
                    ...
                    case 14:
                        {
                            ...
                            pm.Send(new ContinueHighlightKRUIElement(pm.Serial, 0x791F, pm.Serial));

                            pm.Send(new KRDisplayWaypoint(Serial.MinusOne, new Point3D(3665, 2630, 0), Map.Trammel, WaypointType.QuestDestination, true, 1078266)); // Walk Toward Here
                    ...
                    case 23:
                        {
                            ...
                            pm.Send(new KRDisplayWaypoint(Serial.MinusOne, new Point3D(3655, 2604, 0), Map.Trammel, WaypointType.QuestDestination, true, 1078266)); // Walk Toward Here
                    ...
                    case 25:
                        {
                            ...
                            pm.Send(new KRDisplayWaypoint(Serial.MinusOne, new Point3D(3623, 2611, 0), Map.Trammel, WaypointType.QuestDestination, true, 1078266)); // Walk Toward Here
                    ...
                    case 27:
                        {
                            ...
                            pm.Send(new KRDisplayWaypoint(Serial.MinusOne, new Point3D(3632, 2578, 0), Map.Trammel, WaypointType.QuestDestination, true, 1078266)); // Walk Toward Here
                    ...
                    case 30:
                        {
                            ...
                            pm.Send(new KRDisplayWaypoint(Serial.MinusOne, new Point3D(3540, 2568, 0), Map.Trammel, WaypointType.QuestDestination, true, 1078266)); // Walk Toward Here

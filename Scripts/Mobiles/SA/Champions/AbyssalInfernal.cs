/* 	Special Attacks need adjusted to uoguide */
using System;
...
namespace Server.Mobiles
{
    ...
    public class AbyssalInfernal : BaseChampion
    {
            ...
            : base(AIType.AI_Mage)
        {
            ...
            this.SetResistance(ResistanceType.Physical, 54);
            this.SetResistance(ResistanceType.Fire, 72);
            this.SetResistance(ResistanceType.Cold, 58);
            this.SetResistance(ResistanceType.Poison, 39);
            this.SetResistance(ResistanceType.Energy, 72);

            this.SetSkill(SkillName.Wrestling, 113.8);
            this.SetSkill(SkillName.Anatomy, 113.3);
            this.SetSkill(SkillName.MagicResist, 120.0);
            this.SetSkill(SkillName.Magery, 132.2);
            this.SetSkill(SkillName.EvalInt, 123.9);
            this.SetSkill(SkillName.Meditation, 100.0);
            this.SetSkill(SkillName.Tactics, 119.8);
        ...
        public override void OnDamagedBySpell(Mobile caster)
        {
            if (this.Map != null && caster != this && caster is PlayerMobile && 0.20 > Utility.RandomDouble())
            {
                ...
                ItemAttributes.Damage(caster, Utility.RandomMinMax(75, 85), 0, 100, 0, 0, 0);

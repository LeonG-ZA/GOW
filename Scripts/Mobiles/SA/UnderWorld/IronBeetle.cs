    ...
    public class IronBeetle : BaseCreature
    {
        ...
        public void DoMining()
        {
            ...
            if (skillBase >= resource.ReqSkill && this.CheckSkill(def.Skill, resource.MinSkill, resource.MaxSkill))
            {
                ...
                if (type != null)
                {
                    Item item = system.Construct(type, this);
                    ...
                    else
                    {
                        ...
                        {
                            Item bonusItem = system.Construct(bonus.Type, this);
        ...
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            if (Controlled && ControlMaster == from)
            {
                ...
                list.Add(new BaseHarvestTool.ToggleMiningStoneEntry(pm, true, true, 6177));
            }
        }
        #endregion

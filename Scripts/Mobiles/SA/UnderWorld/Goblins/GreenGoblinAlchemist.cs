    ...
    public class GreenGoblinAlchemist : BaseCreature
    {
                    ...
                    delegate
                    {
                        ...
                        switch (Utility.Random(3))
                        {
                            case 0: // The bottle was empty
                                {
                                    from.PlaySound(0x3F);
                                    ItemAttributes.Damage(from, this, Utility.RandomMinMax(5, 10), 100, 0, 0, 0, 0);
                            ...
                            case 1: // Supernova Potion
                                {
                                    ...
                                    for (int i = 0; i < targets.Count; i++)
                                    {
                                        ...
                                        ItemAttributes.Damage(target, this, Utility.RandomMinMax(45, 55), 0, 100, 0, 0, 0);
                                    }
        ...
        private class AcidTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                ...
                ItemAttributes.Damage(m_Target, Utility.RandomMinMax(10, 15), 0, 0, 0, 100, 0);
            }
        }
    }
}
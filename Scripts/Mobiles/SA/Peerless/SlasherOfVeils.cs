...
namespace Server.Mobiles
{
    ...
    public class SlasherOfVeils : BaseCreature
    {
        ...
        private void AngryFire(Mobile defender)
        {
            ...
            ItemAttributes.Damage(defender, this, damage, 0, 100, 0, 0, 0);
        ...
        private class RockRainTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                ...
                if (m_Target.Alive)
                    ItemAttributes.Damage(m_Target, Utility.RandomMinMax(25, 35), 100, 0, 0, 0, 0);
        ...
        private static Type[] UniqueArtifacts = new Type[]
			{
				...
				typeof( Mangler ),			typeof( GargishSignOfChaos ),

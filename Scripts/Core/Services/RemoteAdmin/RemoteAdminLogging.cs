...
namespace Server.RemoteAdmin
{
    public class RemoteAdminLogging
    {
        ...
        private static bool m_Enabled = LogConfig.LogRemoteAdminLoggingEnabled;
        private static bool Initialized = LogConfig.LogRemoteAdminLoggingInitializedEnabled;
        const string LogBaseDirectory = LogConfig.LogRemoteAdminLogBaseDirectory;
        const string LogSubDirectory = LogConfig.LogRemoteAdminLogSubDirectory;

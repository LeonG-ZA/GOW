                ...
                case AccessLevel.Counselor:
                    {
                        ...
                        entries.Add(CommandSystem.Prefix + "WorldCreator"); entries.Add(CommandSystem.Prefix + "M Tele");
                ...
                case AccessLevel.Administrator:
                    {
                        ...
                        entries.Add(CommandSystem.Prefix + "WorldCreator"); entries.Add(CommandSystem.Prefix + "SpawnEditor");

...
{
	public class LittleButtonGump : Gump
	{
		public LittleButtonGump( string text )
			: base( 0, 0 )
		{
			AddPage( 0 );

			AddButton( 23, 40, 0x845, 0x846, 0, GumpButtonType.Reply, 0 );
			AddLabel( 0, 50, 0x2B, text );
		}
	}

	public class MessageSentGump : LittleButtonGump
	{
	...
	public class PageQueueGump : Gump
	{
			...
			: base( 30, 30 )
		{
			...
			Add( new GumpAlphaRegion( 0, 0, 410, 448 ) );

			AddHtml( 180, 12, 200, 20, Color( "Page Queue", LabelColor32 ), false, false );
				...
				case 4: // handle page
					{
						if ( m_Entry.Handler == null )
						{
							...
							m_Entry.Sender.SendMessage( 0x35, "Your petition has been received by the game master staff. You should receive a response or chat request soon. Thank you!" );

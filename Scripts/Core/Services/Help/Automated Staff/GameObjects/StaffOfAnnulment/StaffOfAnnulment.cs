...
namespace Server.Items.Staff
{
    ...
    public class StaffOfAnnulment : BaseStaff
    {
        ...
        public bool CanDeleteCorpse { get { return DeleteCorpse; } set { DeleteCorpse = value; } }

        [CommandProperty(AccessLevel.GameMaster)]
        public bool CanDeleteItem { get { return DeleteItems; } set { DeleteItems = value; } }

        [CommandProperty(AccessLevel.GameMaster)]
        public bool CanKillInvul { get { return KillInvul; } set { KillInvul = value; } }

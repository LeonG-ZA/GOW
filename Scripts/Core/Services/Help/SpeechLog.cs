...
namespace Server.Engines.Help
{
    public class SpeechLog : IEnumerable<SpeechLogEntry>
    {
        ...
        public static readonly bool Enabled = LogConfig.LogSpeechLoggingEnabled;

        // How long should we maintain each speech entry?
        public static readonly TimeSpan EntryDuration = LogConfig.LogSpeechEntryDuration;

        // What is the maximum number of entries a log can contain? (0 -> no limit)
        public static readonly int MaxLength = LogConfig.LogSpeechMaxLength;

...
namespace Server.Engines.Tracker
{
	...
	{
        public static readonly bool Enabled = FeaturesConfig.FeatTrackerSystemEnabled;
		...
		public static void Initialize()
		{
			...
			{
				CommandSystem.Register( "AddIssue", AccessLevel.Player, new CommandEventHandler( OnCommand_AddIssue ) );
				CommandSystem.Register( "ViewIssues", AccessLevel.Player, new CommandEventHandler( OnCommand_ViewIssues ) );

...
namespace Server.Engines.ConPVP
{
    ...
    public class DuelContext
    {
        ...
        public bool IsSuddenDeath
        {
            get
            {
                return m_IsSuddenDeath;
            }
            set
            {
                m_IsSuddenDeath = value;
            }
        }
        ...
        public bool StartedBeginCountdown
        {
            get
            {
                return m_StartedBeginCountdown;
            }
        }
        public bool StartedReadyCountdown
        {
            get
            {
                return m_StartedReadyCountdown;
            }
        }
        ...
        public static void CancelSpell(Mobile mob)
        {
            ...
            {
                ((Spell)mob.Spell).Disturb(Spells.DisturbType.Kill);
            }

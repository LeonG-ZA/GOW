...
namespace Server.Engines.ConPVP
{
                        ...
                        case TournamentStage.Inactive:
                            {
                                if (m_Registrar != null)
                                {
                                    m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x35, false, "The tournament is closed.", from.NetState);
                                }
                        ...
                        case TournamentStage.Signup:
                            {
                                ...
                                if (ladder != null)
                                {
                                    ...
                                    if (entry != null && Ladder.GetLevel(entry.Experience) < tourny.LevelRequirement)
                                    {
                                        if (m_Registrar != null)
                                        {
                                            m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x35, false, "You have not yet proven yourself a worthy dueler.", from.NetState);
                                        }
                                ...
                                if (from.HasGump(typeof(AcceptTeamGump)))
                                {
                                    if (m_Registrar != null)
                                    {
                                        m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x22, false, "You must first respond to the offer I've given you.", from.NetState);
                                    }
                                }
                                else if (from.HasGump(typeof(AcceptDuelGump)))
                                {
                                    if (m_Registrar != null)
                                    {
                                        m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x22, false, "You must first cancel your duel offer.", from.NetState);
                                    }
                                }
                                else if (from is PlayerMobile && ((PlayerMobile)from).DuelContext != null)
                                {
                                    if (m_Registrar != null)
                                    {
                                        m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x22, false, "You are already participating in a duel.", from.NetState);
                                    }
                                }
                                ...
                                {
                                    m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x35, false, "You have already entered this tournament.", from.NetState);
                                }
    ...
    public class ConfirmSignupGump : Gump
    {
                    ...
                    case TournamentStage.Fighting:
                        {
                            if (m_Registrar != null)
                            {
                                ...
                                {
                                    m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x35, false, "Excuse me? You are already signed up.", from.NetState);
                                }
                                else
                                {
                                    m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x22, false, "The tournament has already begun. You are too late to signup now.", from.NetState);
                                }
                            }
                    ...
                    case TournamentStage.Signup:
                        {
                            if (m_Players.Count != tourny.PlayersPerParticipant)
                            {
                                if (m_Registrar != null)
                                {
                                    m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x35, false, "You have not yet chosen your team.", from.NetState);
                                }
                            ...
                            for (int i = 0; i < m_Players.Count; ++i)
                            {
                                ...
                                if (entry != null && Ladder.GetLevel(entry.Experience) < tourny.LevelRequirement)
                                {
                                    if (m_Registrar != null)
                                    {
                                        ...
                                        {
                                            m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x35, false, String.Format("{0} has not yet proven themselves a worthy dueler.", mob.Name), from.NetState);
                                        }
                                    }
                                ...
                                else if (tourny.HasParticipant(mob))
                                {
                                    if (m_Registrar != null)
                                    {
                                        ...
                                        {
                                            m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x35, false, String.Format("{0} has already entered this tournament.", mob.Name), from.NetState);
                                        }
                                    }
                                ...
                                else if (mob is PlayerMobile && ((PlayerMobile)mob).DuelContext != null)
                                {
                                    if (m_Registrar != null)
                                    {
                                        if (mob == from)
                                        {
                                            m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x35, false, "You are already assigned to a duel. You must yield it before joining this tournament.", from.NetState);
                                        }
                                        else
                                        {
                                            m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x35, false, String.Format("{0} is already assigned to a duel. They must yield it before joining this tournament.", mob.Name), from.NetState);
                                        }
                                    }
                            ...
                            if (m_Registrar != null)
                            {
                                ...
                                m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x35, false, String.Format(fmt, from.Female ? "Lady" : "Lord", timeUntil), from.NetState);
                            }
        ...
        private void AddPlayer_OnTarget(Mobile from, object obj)
        {
            ...
            if (mob == null || mob == from)
            {
                ...
                if (m_Registrar != null)
                {
                    m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x22, false, "Excuse me?", from.NetState);
                }
            }
            else if (!mob.Player)
            {
            ...
            else if (AcceptDuelGump.IsIgnored(mob, from) || mob.Blessed)
            {
                ...
                if (m_Registrar != null)
                {
                    m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x22, false, "They ignore your invitation.", from.NetState);
                }
            }
            else
            {
                ...
                if (pm.DuelContext != null)
                {
                    ...
                    if (m_Registrar != null)
                    {
                        m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x22, false, "They are already assigned to another duel.", from.NetState);
                    }
                }
                else if (mob.HasGump(typeof(AcceptTeamGump)))
                {
                    ...
                    if (m_Registrar != null)
                    {
                        m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x22, false, "They have already been offered a partnership.", from.NetState);
                    }
                }
                else if (mob.HasGump(typeof(ConfirmSignupGump)))
                {
                    ...
                    if (m_Registrar != null)
                    {
                        m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x22, false, "They are already trying to join this tournament.", from.NetState);
                    }
                }
                else if (m_Players.Contains(mob))
                {
                    ...
                    if (m_Registrar != null)
                    {
                        m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x22, false, "You have already named them as a team member.", from.NetState);
                    }
                }
                else if (m_Tournament.HasParticipant(mob))
                {
                    ...
                    if (m_Registrar != null)
                    {
                        m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x22, false, "They have already entered this tournament.", from.NetState);
                    }
                }
                else if (m_Players.Count >= m_Tournament.PlayersPerParticipant)
                {
                    ...
                    if (m_Registrar != null)
                    {
                        m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x22, false, "Your team is full.", from.NetState);
                    }
                }
                else
                {
                    ...
                    if (m_Registrar != null)
                    {
                        m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x59, false, String.Format("As you command m'{0}. I've given your offer to {1}.", from.Female ? "Lady" : "Lord", mob.Name), from.NetState);
                    }
                }
            }
        }
    ...
    public class AcceptTeamGump : Gump
    {
        ...
        public void AutoReject()
        {
            ...
            if (m_Registrar != null)
            {
                m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x22, false, String.Format("{0} seems unresponsive.", m_Requested.Name), m_From.NetState);

                m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x22, false, String.Format("You have declined the partnership with {0}.", m_From.Name), m_Requested.NetState);
            }
        }
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            if (info.IsSwitched(1))
            {
                ...
                else
                {
                    ...
                    if (m_Registrar != null)
                    {
                        m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x59, false, String.Format("{0} has accepted your offer of partnership.", mob.Name), from.NetState);

                        m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x59, false, String.Format("You have accepted the partnership with {0}.", from.Name), mob.NetState);
                    }
                }
            }
            else
            {
                ...
                if (m_Registrar != null)
                {
                    m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x22, false, String.Format("{0} has declined your offer of partnership.", mob.Name), from.NetState);

                    m_Registrar.PrivateOverheadMessage(MessageType.Regular, 0x22, false, String.Format("You have declined the partnership with {0}.", from.Name), mob.NetState);
                }
            }
        }
    }
    ...
    public class Tournament
    {
        ...
        public bool IsNotoRestricted
        {
            get
            {
                return (m_TournyType != TournyType.Standard);
            }
        }
        ...
        public int SuddenDeathRounds
        {
            get
            {
                return m_SuddenDeathRounds;
            }
            set
            {
                m_SuddenDeathRounds = value;
            }
        }
        ...
        public int PlayersPerParticipant
        {
            get
            {
                return m_PlayersPerParticipant;
            }
            set
            {
                if (value < 1)
        ...
        public int LevelRequirement
        {
            get
            {
                return m_LevelRequirement;
            }
            set
            {
                m_LevelRequirement = value;
            }
        }
        ...
        public TimeSpan SignupPeriod
        {
            get
            {
                return m_SignupPeriod;
            }
            set
            {
                m_SignupPeriod = value;
            }
        }
    ...
    public class TournyMatch
    {
        ...
        public bool InProgress
        {
            get
            {
                return (m_Context != null && m_Context.Registered);
            }
        }
    ...
    public class TournyParticipant : IComparable
    {
        ...
        public int FreeAdvances
        {
            get
            {
                return m_FreeAdvances;
            }
            set
            {
                m_FreeAdvances = value;
            }
        }
                ...
                case 0:
                    {
                        ...
                        {
                            case 0:
                                m_From.SendGump(new TournamentBracketGump(m_From, m_Tournament, TournyBracketGumpType.Index, null, 0, null));
                                break;
                            case 1:
                                m_From.SendGump(new TournamentBracketGump(m_From, m_Tournament, TournyBracketGumpType.Participant_List, null, 0, null));
                                break;
                            case 2:
                                m_From.SendGump(new TournamentBracketGump(m_From, m_Tournament, TournyBracketGumpType.Round_List, null, 0, null));
                                break;
                            case 4:
                                m_From.SendGump(new TournamentBracketGump(m_From, m_Tournament, TournyBracketGumpType.Rules_Info, null, 0, null));
                                break;
                            case 3:
                                {

...
namespace Server.Mobiles
{
    public class RandomItemGenerator
    {
        ...
        public static void Initialize()
        {
            ...
            m_Table[typeof(AndrosTheDreadLord)] = new List<DropEntry>();
            m_Table[typeof(AndrosTheDreadLord)].Add(new DropEntry(null, 50, 15));

            m_Table[typeof(AdrianTheGloriousLord)] = new List<DropEntry>();
            m_Table[typeof(AdrianTheGloriousLord)].Add(new DropEntry(null, 50, 15));
        }
        ...
        public static bool GenerateRandomItem(Item item, Mobile killer, BaseCreature victim)
        {
            ...
            if (victim != null /*&& victim.Map == Map.Felucca*/)
            {
                return RunicReforging.GenerateRandomItem(item, killer, victim);
            }
            ...
            if (victim.Region != null && victim.Region.IsPartOf(typeof(ShameRegion)))
            {
                return RunicReforging.GenerateRandomItem(item, killer, victim);
            }
            //}

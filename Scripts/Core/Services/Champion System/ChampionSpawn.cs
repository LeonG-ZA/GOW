...
namespace Server.Engines.ChampionSpawns
{
    public class ChampionSpawn : Item
    {
            ...
            else
            {
                ...
                for (int i = 0; i < m_Creatures.Count; ++i)
                {
                    ...
                    if (m.Deleted)
                    {
                        ...
                        {
                            ((Corpse)m.Corpse).BeginDecay(TimeSpan.FromMinutes(1.0));
                        }
                        ...
                        {
                            if (m.Fame > Utility.Random(1000000))
                            {
                            ...
                            if (mobSubLevel >= 0)
                            {
                                ...
                                switch (m_Type)
                                {
                                    case ChampionSpawnType.ColdBlood: type = 0; break;
                                    case ChampionSpawnType.ForestLord: type = 1; break;
                                    case ChampionSpawnType.Arachnid: type = 2; break;
                                    case ChampionSpawnType.Abyss: type = 3; break;
                                    case ChampionSpawnType.VerminHorde: type = 4; break;
                                    case ChampionSpawnType.UnholyTerror: type = 5; break;
                                    case ChampionSpawnType.SleepingDragon: type = 6; break;
                                    case ChampionSpawnType.Corrupt: type = 7; break;
                                    case ChampionSpawnType.Glade: type = 8; break;
                                    case ChampionSpawnType.Unliving: type = 9; break;
                                    case ChampionSpawnType.Pit: type = 10; break;
                                    case ChampionSpawnType.Valley: type = 11; break;
                                }
        ...
        public void GiveArtifact(Mobile to, Item artifact)
        {
            ...
            Effects.SendMovingParticles(new Entity(Serial.Zero, new Point3D(to.X - 6, to.Y - 6, to.Z + 15), to.Map), to, 0x36D4, 7, 0, false, true, 0x497, 0, 9502, 1, 0, (EffectLayer)255, 0x100);
            Effects.SendMovingParticles(new Entity(Serial.Zero, new Point3D(to.X - 4, to.Y - 6, to.Z + 15), to.Map), to, 0x36D4, 7, 0, false, true, 0x497, 0, 9502, 1, 0, (EffectLayer)255, 0x100);
            Effects.SendMovingParticles(new Entity(Serial.Zero, new Point3D(to.X - 6, to.Y - 4, to.Z + 15), to.Map), to, 0x36D4, 7, 0, false, true, 0x497, 0, 9502, 1, 0, (EffectLayer)255, 0x100);

...
namespace Server.Engines.ChampionSpawns
{
    public class ChampionSpawnController : Item
    {
        ...
        private ArrayList m_FelSpawn;
        private ArrayList m_EodonSpawn;
        ...
        {
            new SpawnRecord( (int)ChampionSpawnType.Corrupt, 174, 1629, 10 ), // Bedlam cemetery
		};

        private SpawnRecord[] m_Fel = new SpawnRecord[]
        {
            new SpawnRecord( (int)ChampionSpawnType.Unliving, 7001, 1008, 5 ), // Primeval Lich Fel
		};

        private SpawnRecord[] m_Eodon = new SpawnRecord[]
        {
            new SpawnRecord( (int)ChampionSpawnType.Valley, 452, 1698, 59 ), // Eodon Valley
		};
        ...
        public TimeSpan RestartDelay
        {
            ...
            set
            {
                ...
                foreach (ChampionSpawn cs in m_FelSpawn)
                {
                    cs.RestartDelay = m_RestartDelay;
                }

                foreach (ChampionSpawn cs in m_EodonSpawn)
                {
                    cs.RestartDelay = m_RestartDelay;
                }
            }
        ...
        public ChampionSpawnController() : base(0x3EDD)
        {
            ...
            m_FelSpawn = new ArrayList();
            m_EodonSpawn = new ArrayList();
        ...
        private void Generate()
        {
            ...
            for (i = 0; i < m_Fel.Length; i++)
            {
                ChampionSpawn cs = CreateAltar(m_Fel[i], Map.Felucca, true);

                m_AllSpawn.Add(cs);
                m_FelSpawn.Add(cs);
            }

            for (i = 0; i < m_Eodon.Length; i++)
            {
                ChampionSpawn cs = CreateAltar(m_Eodon[i], Map.TerMur, false);
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            writer.WriteItemList(m_FelSpawn);
            writer.WriteItemList(m_EodonSpawn);
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            m_FelSpawn = reader.ReadItemList();
            m_EodonSpawn = reader.ReadItemList();

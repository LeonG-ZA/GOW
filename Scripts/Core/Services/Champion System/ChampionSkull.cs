    ...
    public class ChampionSkull : Item
    {
            ...
            : base(0x1AE1)
        {
            ...
            switch (type)
            {
                ...
                case ChampionSkullType.Death: Hue = 0x026; break;
                case ChampionSkullType.Pain: Hue = 0x036; break;
                case ChampionSkullType.Terror: Hue = 0x4F2; break;
                case ChampionSkullType.Infuse: Hue = 0x550; break;
                case ChampionSkullType.DTurtle: Hue = 0x026; break;
            }
        }

...
namespace Server.Factions
{
    public static class Settings
    {
        ...
        {
            NewCoMLocation = FactionConfig.NewCoMLocation;
        }
    }
                        ...
                        if (acct != null)
                        {
                            ...
                            for (int i = 0; i < acct.Length; ++i)
                            {
                                ...
                                if (mob != null)
                                {
                                    ...
                                    {
                                        pl.Faction.RemoveMember(mob);
                                        mob.SendMessage("You have been banned from your faction.");
                                        this.AddResponse("They have been banned from their faction.");
                                    }
                                }
                            }
                        }

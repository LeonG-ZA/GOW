...
namespace Server.Engines.VeteranRewards
{
    ...
    {
        public static bool Enabled = VeteranRewardsConfig.RewardEnabled;
        public static bool SkillCapRewards = VeteranRewardsConfig.SkillCapRewards;
        public static int SkillCap = VeteranRewardsConfig.SkillBonusCap;
        public static int SkillCapBonusIncrement = VeteranRewardsConfig.SkillCapBonusIncrement;
        public static int SkillCapBonusLevels = VeteranRewardsConfig.SkillCapBonusLevels;
        public static TimeSpan RewardInterval = VeteranRewardsConfig.RewardInterval;
        public static int StartingLevel = VeteranRewardsConfig.StartingLevel;
        //private static bool m_AgeCheckOnUse = VeteranRewardsConfig.AgeCheckOnUse;
        ...
        public static void SetupRewardTables()
        {
            ...
            m_Lists = new RewardList[]
            {
                ...
                new RewardList(RewardInterval, 5, new RewardEntry[]
                {
                    ...
                    //MetallicPlatedyetub
                    new RewardEntry(specialDyeTubs, 1049741, typeof(MetallicLeatherDyeTub)),
                ...
                new RewardList(RewardInterval, 7, new RewardEntry[]
                {
                    ...
                    //Sheep Statue
                    new RewardEntry(houseAddOns,	1123504, typeof(SewingMachineEastDeed), Expansion.SA),
                    new RewardEntry(houseAddOns,	1123504, typeof(SewingMachineSouthDeed), Expansion.SA),
                    new RewardEntry(houseAddOns,	1123578, typeof(SmithingPressEastDeed), Expansion.SA),
                    new RewardEntry(houseAddOns,	1123578, typeof(SmithingPressSouthDeed), Expansion.SA),
                    new RewardEntry(houseAddOns,	1123504, typeof(SpinningLatheEastDeed), Expansion.SA),
                    new RewardEntry(houseAddOns,	1123504, typeof(SpinningLatheSouthDeed), Expansion.SA),
                    new RewardEntry(houseAddOns,	1123504, typeof(FletchingStationEastDeed), Expansion.SA),
                    new RewardEntry(houseAddOns,	1123504, typeof(FletchingStationSouthDeed), Expansion.SA)
                }),
                new RewardList(RewardInterval, 8, new RewardEntry[]
                {
                    ...
                    new RewardEntry(houseAddOns,	1153535, typeof(DaviesLockerDeed), Expansion.ML)
                    //Gadgetry Table
                }),
                ...
                new RewardList(RewardInterval, 10, new RewardEntry[]
                {
                    ...
                    new RewardEntry(houseAddOns, 1150050, typeof(DolphinRugEWDeed), Expansion.ML),
                    new RewardEntry(houseAddOns, 1150051, typeof(DolphinRugNSDeed), Expansion.ML),
                    new RewardEntry(houseAddOns, 1150048, typeof(RoseRugSmallSouthDeed), Expansion.ML),
                    new RewardEntry(houseAddOns, 1150049, typeof(RoseRugSmallEastDeed), Expansion.ML),
                    new RewardEntry(houseAddOns, 1150046, typeof(SkullRugSmallSouthDeed), Expansion.ML),
                    new RewardEntry(houseAddOns, 1150047, typeof(SkullRugSmallEastDeed), Expansion.ML)
                }),
                ...
                new RewardList(RewardInterval, 14, new RewardEntry[]
                {
                    new RewardEntry(etherealSteeds,	1113813, typeof(EtherealHiryu), Expansion.ML)
                ...
                {
                    new RewardEntry(etherealSteeds,	1154589, typeof(EtherealTiger), Expansion.SA),
                    new RewardEntry(etherealSteeds,	1155724, typeof(EtherealAncientHellHound), Expansion.SA)
                    //Garden Shed Add-On
                }),
            };
        }

...
namespace Server.Regions
{
    public class TwistedWealdDesert : MondainRegion
    {
        ...
        {
            if (m.NetState != null &&
                !TransformationSpell.UnderTransformation(m, typeof(AnimalForm)) &&
        ...
        public override void OnExit(Mobile m)
        {
            if (m.NetState != null &&
                !TransformationSpell.UnderTransformation(m, typeof(AnimalForm)) &&
                !TransformationSpell.UnderTransformation(m, typeof(Server.Spells.Spellweaving.ReaperFormSpell)))

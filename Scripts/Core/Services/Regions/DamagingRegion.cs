...
namespace Server.Regions
{
    ...
    { 
        ...
        public Hashtable Table { get { return this._Table; } }
        ...
        public void StartTimer(Mobile m)
        {
            ...
            this._Table[m] = Timer.DelayCall(TimeSpan.Zero, this.DamageInterval, new TimerStateCallback(Damage), m);
        }
        ...
        public void StopTimer(Mobile m)
        {
            ...
            if (this._Table[m] != null)
            {
                Timer timer = (Timer)this._Table[m];			
                timer.Stop();
            }
        }
        ...
        public virtual void Damage(Mobile m)
        {
            ...
            if (m.NetState != null)
            {
                ...
                if (m is PlayerMobile)
                {
                    ...
                    dmg = (int)Pub57.ThieveItems.BalmOfProtection.HandleDamage(pm, dmg);
                }
                ItemAttributes.Damage(m, dmg, 0, 0, 100, 0, 0);
            }
             */
    ...
    public class CrystalField : DamagingRegion
    {
        ...
        public override void Damage(Mobile m)
        {
            ...
            if (m.NetState != null)
            {
                ItemAttributes.Damage(m, Utility.Random(2, 6), 0, 0, 100, 0, 0);
            }
            else
            {
    ...
    { 
        ...
        public override void Damage(Mobile m)
        {
            ...
            if (m.NetState != null)
            {
                ItemAttributes.Damage(m, Utility.Random(2, 3), 0, 0, 100, 0, 0);
            }
        }
    }
    ...
    { 
        ...
        public override void Damage(Mobile m)
        {
            ...
            if (m.NetState != null)
            {
                ...
                m.PlaySound(0x229);
                ItemAttributes.Damage(m, Utility.Random(2, 3), 0, 0, 0, 100, 0);
            }
        }
    }

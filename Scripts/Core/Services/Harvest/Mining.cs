        ...
        private Mining()
        {
            ...
            if (Core.ML)
            {
                oreAndStone.BonusResources = new BonusHarvestResource[]
                {
					...
					new BonusHarvestResource( 100, 0.1, 1072562, typeof( BlueDiamond ) ),
					new BonusHarvestResource( 100, 0.1, 1072567, typeof( DarkSapphire ) ),
					new BonusHarvestResource( 100, 0.1, 1072570, typeof( EcruCitrine ) ),
					new BonusHarvestResource( 100, 0.1, 1072564, typeof( FireRuby ) ),
					new BonusHarvestResource( 100, 0.1, 1072566, typeof( PerfectEmerald ) ),
					new BonusHarvestResource( 100, 0.1, 1072568, typeof( Turquoise ) ),
					new BonusHarvestResource( 100, 0.1, 1072569, typeof( CrystallineBlackrock ), Map.TerMur )
                };
            }

...
namespace Server.Regions
{
    public class SpawnEntry : ISpawner
    {
        ...
        public Map Map { get { return m_Region.Map; } }
        ...
        //void ISpawner.Replace(ISpawnable oldEntity, ISpawnable newEntity)
        //{
        //    m_SpawnedObjects.Remove(oldEntity);
        //    m_SpawnedObjects.Add(newEntity);
        //}

...
namespace Server.Mobiles
{
	public class Spawner : Item, ISpawner
	{
		...
		public bool IsFull{ get{ return ( m_Spawned.Count >= spawnMax ); } }
		...
		public override void OnDoubleClick( Mobile from )
		{
            ...
            from.CloseGump(typeof(SpawnerGump));
			from.SendGump( g );
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			if ( m_Running )
			{
				...
				list.Add( 1060656, spawnMax.ToString() ); // amount to make: ~1_val~
		...
		{
			return ( m_Spawned.Count >= spawnMax );
		}

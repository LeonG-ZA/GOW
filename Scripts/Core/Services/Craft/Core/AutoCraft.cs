...
namespace Server.Engines.Craft
{
    public class MakeNumberCraftPrompt : Prompt
    {
        ...
        public MakeNumberCraftPrompt(Mobile from, CraftSystem system, CraftItem item, IUsesRemaining tool)
        {
            m_From = from;
    ...
    public class AutoCraftTimer : Timer
    {
        ...
        public AutoCraftTimer(Mobile from, CraftSystem system, CraftItem item, IUsesRemaining tool, int amount, TimeSpan delay, TimeSpan interval)
            : base(delay, interval)
        {
            m_From = from;
            m_CraftSystem = system;
        ...
        //public AutoCraftTimer(Mobile from, CraftSystem system, CraftItem item, BaseTool tool, int amount)
        public AutoCraftTimer(Mobile from, CraftSystem system, CraftItem item, IUsesRemaining tool, int amount)

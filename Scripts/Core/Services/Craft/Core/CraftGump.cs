...
namespace Server.Engines.Craft
{
    public class CraftGump : Gump
    {
        ...
        public CraftGump(Mobile from, CraftSystem craftSystem, IUsesRemaining tool, object notice)
            : this(from, craftSystem, tool, notice, CraftPage.None)
        {
        }
        ...
        //private CraftGump(Mobile from, CraftSystem craftSystem, BaseTool tool, object notice, CraftPage page)
            //: base(50, 50)
        private CraftGump(Mobile from, CraftSystem craftSystem, IUsesRemaining tool, object notice, CraftPage page)
            : base(40, 40)
        {
            m_From = from;
            ...
            AddBackground( 0, 0, 530, 508, 5054 ); 
 			AddImageTiled( 10, 10, 510, 22, 2624 );//Section for Gump Heading
            AddImageTiled(10, 292, 150, 45, 2624);//Section for Notices
            AddImageTiled(165, 292, 355, 45, 2624);//Section across from Notices
            AddImageTiled(10, 342, 510, 155, 2624);//Section where Exit is
            AddImageTiled(10, 37, 200, 250, 2624); //Section for Categories
            AddImageTiled(215, 37, 305, 250, 2624); //Section for Sublisted Items
			...
			// Alter option
            if (Core.SA && craftSystem.CanAlter)
            {
				AddButton(270, 402, 4005, 4007, GetButtonID(6, 9), GumpButtonType.Reply, 0);
				AddHtmlLocalized(304, 405, 1152, 18, 1094726, LabelColor, false, false); // ALTER ITEM
            }
            // ****************************************
            ...
            if (Core.SA)
            {
                ...
                AddHtmlLocalized(305, 425, 150, 18, 1112533 + (context == null ? 0 : (int)context.QuestOption), LabelColor, false, false);
            }
            // ****************************************
        ...
        public int CreateGroupList()
        {
            ...
            AddButton(15, 60, 4011, 4013, GetButtonID(6, 3), GumpButtonType.Reply, 0);

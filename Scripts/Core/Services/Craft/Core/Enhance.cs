...
namespace Server.Engines.Craft
{
    ...
    public class Enhance
    {
        ...
        //public static void BeginTarget(Mobile from, CraftSystem craftSystem, BaseTool tool)IUsesRemaining
        public static void BeginTarget(Mobile from, CraftSystem craftSystem, IUsesRemaining tool)
        {
            ...
            if (lastRes >= 0 && lastRes < subRes.Count)
            {
                ...
                else
                {
                    ...
                    {
                        from.Target = new EnhanceTarget(craftSystem, tool, res.ItemType, resource);
                        if (user.NextEnhanceSuccess)
                        {
        ...
        private class EnhanceTarget : Target
        {
            ...
            //public EnhanceTarget(CraftSystem craftSystem, BaseTool tool, Type resourceType, CraftResource resource)
            public EnhanceTarget(CraftSystem craftSystem, IUsesRemaining tool, Type resourceType, CraftResource resource)

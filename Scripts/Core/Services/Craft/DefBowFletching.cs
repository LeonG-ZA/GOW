...
namespace Server.Engines.Craft
{
    ...
    public class DefBowFletching : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            if (Core.SA)
            {
                index = this.AddCraft(typeof(ElvenFletchings), 1044457, 1113346, 90.0, 100.0, typeof(Feather), 1044562, 20, 1044563);
                this.AddRes(index, typeof(FaeryDust), 1113358, 1, 502910);
            ...
            if (Core.SE)
            {
                index = this.AddCraft(typeof(FukiyaDart), 1044565, 1030246, 50.0, 90.0, typeof(Board), 1044041, 1, 1044351);
                this.SetUseAllRes(index, true);
            ...
            if (Core.ML)
            {
                ...
                this.AddRes(index, typeof(LardOfParoxysmus), 1032681, 1, 1053098);
                this.AddRes(index, typeof(Putrefaction), 1032678, 10, 1053098);

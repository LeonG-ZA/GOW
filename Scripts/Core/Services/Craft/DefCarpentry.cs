...
namespace Server.Engines.Craft
{
    ...
    public class DefCarpentry : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            if (Core.HS)
            {
                index = this.AddCraft(typeof(ExodusSummoningAlterAddonDeedOnly), 1044294, 1153502, 95.0, 120.0, typeof(Board), 1044041, 100, 1044351);
            ...
            //Ter-Mur Style Chair missing
            //Ter-Mur Style Table missing
            ...
            if (Core.SA)
            {
                index = AddCraft(typeof(GargoyleWoodenChest), 1044292, 1095293, 80.0, 115.0, typeof(Board), 1044041, 30, 1044351);
                SetNeededExpansion(index, Expansion.SA);
            }
            ...
            if (Core.SA)
            {
                AddCraft(typeof(GargishGnarledStaff), 1044566, 1097488, 78.9, 103.9, typeof(Board), 1044041, 7, 1044351);
            }
            ...
            if (Core.SE)
            {
                index = AddCraft(typeof(Tetsubo), 1044566, 1030225, 80.0, 140.3, typeof(Board), 1044041, 10, 1044351);
                SetNeededExpansion(index, Expansion.SE);
            }
            ...
            if (Core.ML)
            {
                ...
                index = AddCraft(typeof(WildStaff), 1044566, 1073551, 63.8, 113.8, typeof(Board), 1044041, 16, 1044351);
                SetNeededExpansion(index, Expansion.ML);
            }
            #endregion
            ...
            if (Core.ML)
            {
                ...
                AddCraft(typeof(GargishWoodenShield), 1062760, 1095775, 52.6, 77.6, typeof(Board), 1044041, 9, 1044351);
            ...
            if (Core.ML)
            {
                ...
                index = AddCraft(typeof(ParrotPerchDeed), 1044290, 1072617, 50.0, 75.0, typeof(Board), 1044041, 50, 1044351);
                ForceNonExceptional(index);
                SetNeededExpansion(index, Expansion.ML);
            }
            ...
            if (Core.SA)
            {
                index = AddCraft(typeof(TerMurStyleDresserEastAddonDeed), 1044290, 1111784, 90.0, 115.0, typeof(Board), 1044041, 60, 1044351);
                SetNeededExpansion(index, Expansion.SA);

                index = AddCraft(typeof(TerMurStyleDresserSouthAddonDeed), 1044290, 1111783, 90.0, 115.0, typeof(Board), 1044041, 60, 1044351);
                SetNeededExpansion(index, Expansion.SA);
            }
            #endregion
            ...
            /*if (Core.SA)
            {
                index = AddCraft(typeof(SoulForgeDeed), 1111809, 1031696, 100.0, 150.0, typeof(Log), 1044041, 150, 1044351);
                AddRes(index, typeof(IronIngot), 1044036, 150, 1044037);
                AddRes(index, typeof(RelicFragment), 1031699, 1);
                SetNeededExpansion(index, Expansion.SA);
            }
             */

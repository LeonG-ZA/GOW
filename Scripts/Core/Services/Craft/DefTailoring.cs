...
namespace Server.Engines.Craft
{
    ...
    public class DefTailoring : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            if (Core.SA)
            {
                AddCraft(typeof(UncutClothCraft), 1044457, 1044458, 0.0, 0.0, typeof(BoltOfCloth), 1044453, 0, 1044454);
                AddCraft(typeof(AllClothCrafting), 1044457, 1044459, 0.0, 0.0, typeof(BaseCloth), 1044455, 0, 1044456);

                index = AddCraft(typeof(LightPowderCharge), 1044457, 1113350, 0.0, 0.0, typeof(Cloth), 1044455, 1, 1044287);
                AddRes(index, typeof(BlackPowder), 1113344, 1, 502910);
                ...
                index = AddCraft(typeof(HeavyPowderCharge), 1044457, 1113350, 0.0, 0.0, typeof(Cloth), 1044455, 1, 1044287);
                AddRes(index, typeof(BlackPowder), 1113344, 4, 502910);
                SetNeededExpansion(index, Expansion.HS);
                //Heavy Powder Charge 1 Cloth  4 Black Powders  0 skill Cannot be Exceptionally crafted.  HS

                index = AddCraft(typeof(AbyssalCloth), 1044457, 1113350, 110.0, 120.0, typeof(BoltOfCloth), 1044453, 10, 1044454);
                AddRes(index, typeof(CrystallineBlackrock), 1113344, 1, 502910);
            ...
            if (Core.AOS)
            {
                index = AddCraft(typeof(FlowerGarland), 1011375, 1028965, 10.0, 35.0, typeof(Cloth), 1044455, 5, 1044287);
                SetNeededExpansion(index, Expansion.AOS);
            }
            ...
            if (Core.SA)
            {
                index = AddCraft(typeof(OrcMask), 1011375, 1025148, 75.0, 120.0, typeof(Cloth), 1044455, 12, 1044287);
                SetNeededExpansion(index, Expansion.SA);
                index = AddCraft(typeof(BearMask), 1011375, 1025445, 77.5, 120.0, typeof(Cloth), 1044455, 15, 1044287);
                SetNeededExpansion(index, Expansion.SA);
                index = AddCraft(typeof(DeerMask), 1011375, 1025448, 77.5, 120.0, typeof(Cloth), 1044455, 15, 1044287);
                SetNeededExpansion(index, Expansion.SA);
                index = AddCraft(typeof(TribalMask), 1011375, 1025451, 82.5, 120.0, typeof(Cloth), 1044455, 12, 1044287);
                SetNeededExpansion(index, Expansion.SA);
                index = AddCraft(typeof(HornedTribalMask), 1011375, 1025451, 82.5, 120.0, typeof(Cloth), 1044455, 12, 1044287);
                SetNeededExpansion(index, Expansion.SA);
            }
            ...
            if(Core.SA)
            {
                index = AddCraft(typeof(GargishRobe), 1111747, 1112739, 53.9, 78.9, typeof(Cloth), 1044455, 16, 1044287);
                SetNeededExpansion(index, Expansion.SA);

                index = AddCraft(typeof(GargishFancyRobe), 1111747, 1112740, 75.1, 100.1, typeof(Cloth), 1044455, 18, 1044287);
                SetNeededExpansion(index, Expansion.SA);
            }
            /*
            if (Core.HS)
            ...
            if(Core.TOL)
            {
                index = AddCraft(typeof(GildedKilt), 1111747, 1109619, 82.8, 78.9, typeof(Cloth), 1044455, 8, 1044287);
                SetNeededExpansion(index, Expansion.TOL);
                index = AddCraft(typeof(CheckeredKilt), 1111747, 1109620, 41.4, 78.9, typeof(Cloth), 1044455, 8, 1044287);
                SetNeededExpansion(index, Expansion.TOL);
                index = AddCraft(typeof(FancyKilt), 1111747, 1109621, 20.7, 78.9, typeof(Cloth), 1044455, 8, 1044287);
                SetNeededExpansion(index, Expansion.TOL);
                index = AddCraft(typeof(FloweredDress), 1111747, 1109622, 75.0, 78.9, typeof(Cloth), 1044455, 18, 1044287);
                SetNeededExpansion(index, Expansion.TOL);
                index = AddCraft(typeof(EveningGown), 1111747, 1109625, 75.0, 78.9, typeof(Cloth), 1044455, 18, 1044287);
                SetNeededExpansion(index, Expansion.TOL);
            }
            ...
            if (Core.SA)
            {
                index = AddCraft(typeof(GargoyleHalfApron), 1015283, 1099569, 20.7, 45.7, typeof(Cloth), 1044455, 6, 1044287);
                SetNeededExpansion(index, Expansion.SA);
                index = AddCraft(typeof(GargishSash), 1015283, 1096963, 4.1, 29.1, typeof(Cloth), 1044455, 4, 1044287);
                SetNeededExpansion(index, Expansion.SA);
            }

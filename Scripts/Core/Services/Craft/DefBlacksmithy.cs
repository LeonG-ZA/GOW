...
namespace Server.Engines.Craft
{
    ...
    public class DefBlacksmithy : CraftSystem
    {
        ...
        public override void PlayCraftEffect(Mobile from)
        {
            ...
            //new DefBlacksmithyTimer( from ).Start();
            from.PlaySound(0x2A);
        }

        // Delay to synchronize the sound with the hit on the anvil
        private class DefBlacksmithyTimer : Timer
        {
            private readonly Mobile m_From;

            public DefBlacksmithyTimer(Mobile from)
        ...
        public override void InitCraftList()
        {
            ...
            */
            ...
            if (Core.SE)
            {
                ...
                index = AddCraft(typeof(PlateDo), 1111704, 1030184, 87.0, 130.0, typeof(IronIngot), 1044036, 28, 1044037);
                SetNeededExpansion(index, Expansion.SE);
            ...
            if (Core.HS)
            {
                index = AddCraft(typeof(LightShipCannonball), 1116354, 1116266, 0, 50.0, typeof(IronIngot), 1044036, 6, 1044037);
                this.ForceNonExceptional(index);
                this.SetNeededExpansion(index, Expansion.HS);

                index = AddCraft(typeof(HeavyShipCannonball), 1116354, 1116267, 10.0, 60.0, typeof(IronIngot), 1044036, 12, 1044037);
                this.ForceNonExceptional(index);
                this.SetNeededExpansion(index, Expansion.HS);

                index = AddCraft(typeof(LightShipGrapeShot), 1116354, 1116030, 0, 50.0, typeof(IronIngot), 1044036, 6, 1044037);
                AddRes(index, typeof(Cloth), 1044286, 1, 1044287);
                this.ForceNonExceptional(index);
                this.SetNeededExpansion(index, Expansion.HS);

                index = AddCraft(typeof(HeavyShipGrapeShot), 1116354, 1116166, 15.0, 70.0, typeof(IronIngot), 1044036, 12, 1044037);
                AddRes(index, typeof(Cloth), 1044286, 2, 1044287);
                this.ForceNonExceptional(index);
                this.SetNeededExpansion(index, Expansion.HS);

                index = AddCraft(typeof(LightCannonDeed), 1116354, 1095790, 65.0, 120.0, typeof(IronIngot), 1044036, 900, 1044037);
                AddRes(index, typeof(Board), 1044041, 50, 1044351);
                AddSkill(index, SkillName.Carpentry, 65.0, 120.0);
                this.ForceNonExceptional(index);
                this.SetNeededExpansion(index, Expansion.HS);

                index = AddCraft(typeof(HeavyCannonDeed), 1116354, 1095797, 70.0, 120.0, typeof(IronIngot), 1044036, 1800, 1044037);
                AddRes(index, typeof(Board), 1044041, 75, 1044351);
                AddSkill(index, SkillName.Carpentry, 70.0, 120.0);
                this.ForceNonExceptional(index);
                this.SetNeededExpansion(index, Expansion.HS);
            }
            #endregion
            ...
            index = AddCraft(typeof(DragonGloves), 3001016, 1029795, 68.9, 118.9, typeof(RedScales), 1060883, 16, 1060884);
            SetUseSubRes2(index, true);
            index = AddCraft(typeof(DragonHelm), 3001016, 1029797, 72.6, 122.6, typeof(RedScales), 1060883, 20, 1060884);
            SetUseSubRes2(index, true);
            index = AddCraft(typeof(DragonLegs), 3001016, 1029799, 78.8, 120.8, typeof(RedScales), 1060883, 28, 1060884);
            SetUseSubRes2(index, true);
            index = AddCraft(typeof(DragonArms), 3001016, 1029815, 76.3, 120.3, typeof(RedScales), 1060883, 24, 1060884);
            SetUseSubRes2(index, true);
            index = AddCraft(typeof(DragonChest), 3001016, 1029793, 85.0, 120.0, typeof(RedScales), 1060883, 1, 1060884);
            SetUseSubRes2(index, true);

            if (Core.SA)
            {
                index = AddCraft(typeof(CrushedGlass), 3001016, 1113351, 110.0, 120.0, typeof(BlueDiamond), 1032696, 1, 1044240);
                AddRes(index, typeof(GlassSword), 1112744, 5, 502910);
                this.ForceNonExceptional(index);
                this.SetNeededExpansion(index, Expansion.SA);

                index = AddCraft(typeof(PowderedIron), 3001016, 1113353, 110.0, 120.0, typeof(WhitePearl), 1032694, 1, 1044240);
                AddRes(index, typeof(IronIngot), 1044036, 20, 1044037);
                this.ForceNonExceptional(index);
                this.SetNeededExpansion(index, Expansion.SA);

                index = AddCraft(typeof(MetalKeg), 3001016, 1150675, 85.0, 120.0, typeof(IronIngot), 1044036, 25, 1044037);
                this.ForceNonExceptional(index);
                this.SetNeededExpansion(index, Expansion.SA);
            }
            /*
            if (Core.HS)
            {
                index = this.AddCraft(typeof(PeerlessExodusSacrificalDagger), 3001016, 1153500, 95.0, 120.0, typeof(IronIngot), 1044036, 12, 1044253);

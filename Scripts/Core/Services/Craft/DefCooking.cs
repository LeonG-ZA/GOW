...
namespace Server.Engines.Craft
{
    ...
    public class DefCooking : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            if (Core.ML)
            {
                index = this.AddCraft(typeof(ParrotWafers), 1044496, 1032246, 37.5, 87.5, typeof(Dough), 1044469, 1, 1044253);
                this.AddRes(index, typeof(JarHoney), 1044472, 1, 1044253);
                this.AddRes(index, typeof(RawFishSteak), 1044476, 10, 1044253);
                this.SetNeededExpansion(index, Expansion.ML);
            }
            ...
            if (Core.SA)
            {
                index = this.AddCraft(typeof(PlantPigment), 1044496, 1112132, 33.0, 83.0, typeof(PlantClippings), 1112131, 1, 1044253);
                this.AddRes(index, typeof(Bottle), 1023854, 1, 1044253);
                this.SetNeededExpansion(index, Expansion.SA);

                index = this.AddCraft(typeof(NaturalDye), 1044496, 1112136, 75.0, 100.0, typeof(PlantPigment), 1112132, 1, 1044253);
                this.AddRes(index, typeof(ColorFixative), 1112135, 1, 1044253);
                this.SetNeededExpansion(index, Expansion.SA);

                index = this.AddCraft(typeof(ColorFixative), 1044496, 1112135, 75.0, 100.0, typeof(SilverSerpentVenom), 1112173, 1, 1044253);
            ...
            if (Core.ML)
            {
                ...
                index = this.AddCraft(typeof(GrapesOfWrath), 1073108, 1072953, 95.0, 145.0, typeof(Grapes), 1073468, 1, 1044253);
            ...
            //Magical Fish Pies cliloc 1116340
        }
    }
}
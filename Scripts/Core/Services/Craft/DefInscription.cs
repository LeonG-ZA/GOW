    ...
    public class DefInscription : CraftSystem
    {
        ...
        public override int CanCraft(Mobile from, IUsesRemaining tool, Type typeItem)
        {
            ...
            if (typeItem != null)
            {
                ...
                if (o is BaseSpellScroll)
                {
                    BaseSpellScroll scroll = (BaseSpellScroll)o;
        ...
        private static readonly Type typeofSpellScroll = typeof(BaseSpellScroll);
        ...
        private enum Reg 
        {
            BlackPearl,   Bloodmoss,     Garlic, 
            Ginseng,      MandrakeRoot,  Nightshade, 
            SulfurousAsh, SpidersSilk,   BatWing, 
            GraveDust,    DaemonBlood,   NoxCrystal, 
            PigIron,      Bone,          DragonBlood, 
        ...
        private readonly Type[] m_RegTypes = new Type[]
        {
            ...
            typeof( PigIron ),      typeof( Bone ),        typeof( DragonBlood ),
			typeof( FertileDirt ),  typeof( DaemonBone )			
        };
        ...
        public override void InitCraftList()
        {
            ...
            if (Core.ML)
            {
                ...
                AddCraft(typeof(MysticismSpellbook), 1044294, "Mysticism spellbook", 50.0, 100.0, typeof(BlankScroll), 1044377, 10, 1044378);
            }

            if (Core.AOS)
            {
                AddCraft(typeof(NecromancerSpellbook), 1044294, "Necromancer spellbook", 50.0, 100.0, typeof(BlankScroll), 1044377, 10, 1044378);
            ...
            if (Core.SA)
            {
                ...
                AddRes(index, typeof(Beeswax), 1025154, 4, 1044253);

                index = AddCraft(typeof(ScrollBinder), 1044294, 1113135, 75.0, 100.0, typeof(WoodPulp), 1113136, 1, 1113289);
            }
            #endregion
            ...
            if (Core.HS)
            {
                index = AddCraft(typeof(PeerlessExodusSummoningRite), 1098336, 1153498, 95.0, 120.0, typeof(DaemonBlood), 1023965, 5, 1044253);
                AddRes(index, typeof(Taint), 1032679, 5, 1044253);

...
namespace Server.Misc
{
    ...
    {
        public const int ItemsPerReward = FeaturesConfig.FeatTOTItemsPerReward;
        ...
        public static bool IsTokunRegion(Region region)
        {
            return region.IsPartOf("Yomotsu Mines") ||
        ...
        public static TreasuresOfTokunoEra DropEra { get { return _DropEra; } set { _DropEra = value; } }
        public static TreasuresOfTokunoEra RewardEra { get { return _RewardEra; } set { _RewardEra = value; } }
        ...
        public static void HandleKill(Mobile victim, Mobile killer)
        {
            ...
            if (FeaturesConfig.FeatTreasureOfTokunoEnabled)
            {

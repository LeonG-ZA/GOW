...
{
	public class BritainLibraryWarriorCollection : BritainLibraryCollection
	{
		public override int Section { get { return 1073449; } } // Mace and Blade Section Donation Representative.
		...
		private static readonly IRewardEntry[] RewardList = new IRewardEntry[]
			{
				...
				// page 6
				new RewardEntry( typeof( MaceAndShieldReadingGlasses ), 800000, 1073381, 12216, 477 ),
			};
		...
		private static readonly DonationEntry[] DonationList = new DonationEntry[]
			{
				...
				new DonationEntry( typeof( Buckler ), 9, 1074907, 7027, 0 ),
				new DonationEntry( typeof( BattleAxe ), 9, 1074908, 3911, 0 ),
				new DonationEntry( typeof( BattleAxe ), 9, 1074908, 3912, 0 ),
		...
		{
			WarriorSectionRepresentative npc = new WarriorSectionRepresentative();
			npc.Controller = this;
		...
		[Constructable]
		public BritainLibraryWarriorCollection()
		{
		}

		public BritainLibraryWarriorCollection( Serial serial )
			: base( serial )
		{
		}

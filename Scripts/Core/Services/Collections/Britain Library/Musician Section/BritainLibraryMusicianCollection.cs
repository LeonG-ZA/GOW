...
{
	public class BritainLibraryMusicianCollection : BritainLibraryCollection
	{
		public override int Section { get { return 1073450; } } // Songs of Note Section Donation Representative.
		...
		private static readonly IRewardEntry[] RewardList = new IRewardEntry[]
			{
				...
				new RewardEntry( typeof( LyricalReadingGlasses ), 800000, 1073382, 12216, 1151 ),
			};
		...
		private static readonly DonationEntry[] DonationList = new DonationEntry[]
			{
				...
				new DonationEntry( typeof( Drums ), 8, 1015116, 3740, 0 ),
				new DonationEntry( typeof( Lute ), 8, 1015117, 3763, 0 ),
				new DonationEntry( typeof( Lute ), 8, 1015117, 3764, 0 ),
		...
		{
			MusicianSectionRepresentative npc = new MusicianSectionRepresentative();
			npc.Controller = this;
		...
		[Constructable]
		public BritainLibraryMusicianCollection()
		{
		}

		public BritainLibraryMusicianCollection( Serial serial )
			: base( serial )
		{
		}

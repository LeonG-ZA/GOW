...
{
    public class BritainLibrarySamuraiCollection : BritainLibraryCollection
    {
        public override int Section { get { return 1073448; } } // Folded Steel Section Donation Representative.
        ...
        private static readonly IRewardEntry[] RewardList = new IRewardEntry[]
            {
				...
				// page 6
				new RewardEntry( typeof( FoldedSteelReadingGlasses ), 800000, 1073380, 12216, 1150 ),
            };
        ...
        private static readonly DonationEntry[] DonationList = new DonationEntry[]
            {
                ...
                new DonationEntry( typeof( BookOfBushido ), 30, 1070814, 9100, 0 ),
                new DonationEntry( typeof( Bokuto ), 8, 1074913, 10152, 0 ),
				
				// page 2
				new DonationEntry( typeof( Bokuto ), 8, 1074913, 10227, 0 ),
                new DonationEntry( typeof( Daisho ), 22, 1074914, 10153, 0 ),
                new DonationEntry( typeof( Daisho ), 22, 1074914, 10228, 0 ),
				
				// page 3
				new DonationEntry( typeof( NoDachi ), 27, 1074915, 10146, 0 ),
                new DonationEntry( typeof( NoDachi ), 27, 1074915, 10221, 0 ),
        ...
        [Constructable]
        public BritainLibrarySamuraiCollection()
        {
        }

        public BritainLibrarySamuraiCollection(Serial serial)
            : base(serial)
        {
        }

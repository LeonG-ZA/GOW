...
{
    public class BritainLibraryPaladinCollection : BritainLibraryCollection
    {
        public override int Section { get { return 1073446; } } // Light and Might Section Donation Representative.
        ...
        private static readonly IRewardEntry[] RewardList = new IRewardEntry[]
            {
				...
				// page 6
				new RewardEntry( typeof( LightOfWayReadingGlasses ), 800000, 1073378, 12216, 598 ),
            };
        ...
        private static readonly DonationEntry[] DonationList = new DonationEntry[]
            {
                ...
                new DonationEntry( typeof( BookOfChivalry ), 12, 1061666, 8786, 0 ),
        ...
        [Constructable]
        public BritainLibraryPaladinCollection()
        {
        }

        public BritainLibraryPaladinCollection(Serial serial)
            : base(serial)
        {
        }

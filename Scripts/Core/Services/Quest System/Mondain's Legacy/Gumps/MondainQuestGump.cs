        ...
        public virtual void SecObjectives()
        {
            ...
            for (int i = 0; i < this.m_Quest.Objectives.Count; i++)
            {
                ...
                else if (objective is DestroyObjectObjective)
                {
                    ...
                    //this.AddHtmlLocalized(98, offset, 40, 16, 1072205, 0x15F90, false, false); // Obtain	
                    //was 143
                    this.AddLabel(98, offset, 0x481, "Destroy " + obtain.MaxProgress + " " + obtain.Name); // %count% + %name%
                ...
                else if (objective is TamingObjective)
                {
                    ...
                    //this.AddHtmlLocalized(98, offset, 40, 16, 1072205, 0x15F90, false, false); // Obtain	
                    //was 143
                    this.AddLabel(98, offset, 0x481, "Tame " + obtain.MaxProgress + " " + obtain.Name); // %count% + %name%

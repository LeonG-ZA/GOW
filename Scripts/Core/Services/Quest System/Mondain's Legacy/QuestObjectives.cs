...
{ 
    ...
    public class InciteObjective : BaseObjective
    {
        ...
        {
            get { return m_Creature1; }
            set { m_Creature1 = value; }
        }

        public List<Type> Creature2
        {
            get { return m_Creature2; }
            set { m_Creature2 = value; }
        }

        public virtual void OnIncite()
        {
            if (Completed)
                Quest.Owner.SendLocalizedMessage(501827); // You have completed your quest!  Return to the person that gave you this task.
            else
                Quest.Owner.SendLocalizedMessage(1115748, true, (MaxProgress - CurProgress).ToString()); // Conflicts remaining to be incited:  ~1_val~.
        }
        public virtual bool IsObjective(Mobile mob1, Mobile mob2)
        {
            if (m_Creature1 == null || m_Creature2 == null)
                return false;

            if ((m_Creature1.Contains(mob1.GetType()) && m_Creature2.Contains(mob2.GetType())) || (m_Creature1.Contains(mob2.GetType()) && m_Creature2.Contains(mob1.GetType())))
            {
                return true;
            }
    ...
    public class CalmObjective : BaseObjective
    {
        ...
        public virtual bool IsObjective(Mobile mob)
        {
            ...
            if (m_Creature.Contains(mob.GetType()))
            {
                return true;
            }
    ...
    public class DiscordObjective : BaseObjective
    {
        ...
        public virtual void OnDiscord()
        {
            if (Completed)
                ...
                Quest.Owner.SendLocalizedMessage(1115749, true, (MaxProgress - CurProgress).ToString()); // Creatures remaining to be discorded: ~1_val~.
        }

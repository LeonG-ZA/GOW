...
namespace Server.Engines.Reports
{
    ...
    {
        private static readonly string FtpHost = WebConfig.WebFtpHost;
        private static readonly string FtpUsername = WebConfig.WebFtpUsername;
        private static readonly string FtpPassword = WebConfig.WebFtpPassword;
        private static readonly string FtpStatsDirectory = WebConfig.WebFtpStatsDirectory;
        private static readonly string FtpStaffDirectory = WebConfig.WebFtpStaffDirectory;
        private const string ShardTitle = WebConfig.WebShardTitle;
        ...
        private HtmlRenderer(string outputDirectory)
        {
            ...
            this.m_OutputDirectory = Path.Combine(Core.BaseDirectory, "Web\\Reports");

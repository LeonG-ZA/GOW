...
namespace Server.Engines.Loyalty
{
	...
	public class LoyaltyInfo
	{
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int BaneChosen { get { return GetValue(LoyaltyGroup.BaneChosen); } set { SetValue(LoyaltyGroup.BaneChosen, value); } }

        [CommandProperty(AccessLevel.GameMaster)]
        public int Ophidian { get { return GetValue(LoyaltyGroup.Ophidian); } set { SetValue(LoyaltyGroup.Ophidian, value); } }

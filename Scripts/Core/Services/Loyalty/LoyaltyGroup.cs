		...
		private static readonly LoyaltyGroupInfo[] m_Table = new LoyaltyGroupInfo[]
			{
				...
				new LoyaltyGroupInfo( 1115734, // Bane Chosen
					1115924, // the Bane Chosen
					15000,
					(k, v) => v.Map == Map.Felucca,
					new TierInfo( -15000, 1095164 ), // Enemy
					new TierInfo(      0, 1011462 ), // Neutral
					new TierInfo(   500, 1115801 ), // Symphatizer
                    new TierInfo(  2000, 1115802 ), // Friend
					new TierInfo(  5000, 1062964 )  // Ally
					),

                new LoyaltyGroupInfo( 1017398, // Ophidian
					1115923, // the Ophidians
					15000,
					(k, v) => v.Map == Map.Felucca,
					new TierInfo( -15000, 1095164 ), // Enemy
					new TierInfo(      0, 1011462 ), // Neutral

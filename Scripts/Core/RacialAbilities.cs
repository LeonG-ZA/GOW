...
namespace Server.Mobiles
{
    public class RacialAbilities
    {
        ...
        {
            private static SpellInfo m_Info = new SpellInfo("Fly", null, -1, 9002);// "", -1);
            ...
            public override bool CheckCast()
            {
                ...
                else if (Caster.Hits < 25) // TODO confirm
                {
                    Caster.SendLocalizedMessage(1112454); // You must heal before flying.
                }
                else
                {
                    if (Caster is PlayerMobile)
                    ...
                    Caster.Animate(9, 1, 1, true, false, 0);
                    return true;
                }

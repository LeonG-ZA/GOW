		...
		public static int Random
		{
			get
			{
				switch ( Utility.Random( 16 ) )
				{
					...
					case 12: RanHue = Utility.RandomSkinHue(); break;
...
*/
        public static int Easter2015
        {
            get
            {
                return Utility.RandomList
                (
                    1200, 1205, 1223, 1257, 1287, 1359,
                    1378, 1462, 1920, 1922, 2503, 2548,
                    2565, 2572, 2598, 2610, 2721
                );
            }
        }
        public static int OphidianRatOrd
        {
            get
            {
                return Utility.RandomList
        ...
        public static int Tree
        {
            get
            {
                return Utility.RandomList
                (
                    0, 1711, 961, 355, 1863, 2114, 1541, 43, 1150, 1518, 2117, 
                    2005, 2346, 2360, 2370
                );
            }
        }
        public static int Dragon
		{
			get
			{
				return Utility.RandomList
				(
                    1309, 2413, 2301, 2126, 2124, 2125, 0
				);
			}
		}

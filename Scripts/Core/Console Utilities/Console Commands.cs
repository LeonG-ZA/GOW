        ...
        public static void Next(string input)
        {
			...
			//  to avoid duplicating logic --sith
                    ...
                    case "report":
                        ...
                        break;
                    case "reload teleporters":
                        {
                            Console.Write("Reloading teleporter configuration paths and files...");
                    ...
                    default:
                    {
                        ...
                        Console.WriteLine("reload teleporters- Reloads the teleport configuration files.");

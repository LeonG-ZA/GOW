...
using Server.Services.BaseAttributes;
...
namespace Server
{
    public class ItemAttributes
    {
        ...
        public static int Damage( Mobile m, Mobile from, int damage, bool ignoreArmor, int phys, int fire, int cold, int pois, int nrgy, int chaos, int direct, bool keepAlive, bool archer, bool deathStrike)
        {
            ...
            /* ALL : The effect of Attunement should go after applying the Blood Oath 
             * Apparently , in the Necro - Arcanists OSI use it a lot in PvP , so that
             * Damage taken to the attacker is reflected by Blood Oath , but then it
             * Attunement absorbed by the defender
            */
    ...
    public enum AosAttribute
    {
        ...
        Brittle = 0x01000000,
        NoRepairs = 0x02000000,
        LowerAmmoCost = 0x01000000,
    ...
    public sealed class AosAttributes : BaseAttributes
    {
        ...
        public int this[AosAttribute attribute] { get { return ExtendedGetValue((int)attribute); } set { SetValue((int)attribute, value); } }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int LowerAmmoCost { get { return this[AosAttribute.LowerAmmoCost]; } set { this[AosAttribute.LowerAmmoCost] = value; } }

        [CommandProperty(AccessLevel.GameMaster)]
        public int CastingFocus { get { return this[AosAttribute.CastingFocus]; } set { this[AosAttribute.CastingFocus] = value; } }
    }
    ...
    public sealed class NegativeAttributes : BaseAttributes
    {
        ...
        {
            if (Brittle > 0 || item is BaseWeapon && ((BaseWeapon)item).Attributes.Brittle > 0 || item is BaseArmor && ((BaseArmor)item).Attributes.Brittle > 0 || item is BaseJewel && ((BaseJewel)item).Attributes.Brittle > 0 || item is BaseClothing && ((BaseClothing)item).Attributes.Brittle > 0)
            {
                list.Add(1116209);
            }
    ...
    public enum AosWeaponAttribute : long
    {
        ...
        UseBestSkill = 0x00200000,
        MageWeapon = 0x00400000,
        DurabilityBonus = 0x00800000,
        ResistPhysicalBonus = 0x01000000,
        ResistFireBonus = 0x02000000,
        ResistColdBonus = 0x04000000,
        ResistPoisonBonus = 0x08000000,
        ResistEnergyBonus = 0x10000000,
        Velocity = 0x20000000,
        Balanced = 0x40000000
    }
    ...
    public sealed class AosWeaponAttributes : BaseAttributes
    {
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int Velocity { get { return this[AosWeaponAttribute.Velocity]; } set { this[AosWeaponAttribute.Velocity] = value; } }

        [CommandProperty(AccessLevel.GameMaster)]
        public int Balanced { get { return this[AosWeaponAttribute.Balanced]; } set { this[AosWeaponAttribute.Balanced] = value; } }
    }
    ...
    public sealed class AosSkillBonuses : BaseAttributes
    {
        ...
        public void CheckCancelMorph(Mobile m)
        {
            ...
            TransformationSpell.TransformContext context = TransformationSpell.GetContext(m);
    ...
    {
        BloodDrinker = 0x00000001,
        BattleLust = 0x00000002,
        CastingFocus = 0x00000004,
        EaterFire = 0x00000008,
        EaterCold = 0x00000010,
        EaterPoison = 0x00000020,
        EaterEnergy = 0x00000040,
        EaterKinetic = 0x00000080,
        EaterDamage = 0x00000100,
        ResonanceFire = 0x00000200,
        ResonanceCold = 0x00000400,
        ResonancePoison = 0x00000800,
        ResonanceEnergy = 0x00001000,
        ResonanceKinetic = 0x00002000,
        SoulChargeFire = 0x00004000,
        SoulChargeCold = 0x00008000,
        SoulChargePoison = 0x00010000,
        SoulChargeEnergy = 0x00020000,
        SoulChargeKinetic = 0x00040000,
        SplinteringWeapon = 0x00080000,
    }
    ...
    public sealed class SAAbsorptionAttributes : BaseAttributes
    {
        ...
        public int BloodDrinker
        {
            get
            {
                return this[SAAbsorptionAttribute.BloodDrinker];
            }
            set
            {
                this[SAAbsorptionAttribute.BloodDrinker] = value;
            }
        }
        ...
        public int BattleLust
        {
            get
            {
                return this[SAAbsorptionAttribute.BattleLust];
            }
            set
            {
                this[SAAbsorptionAttribute.BattleLust] = value;
            }
        }
        ...
        public int SplinteringWeapon
        {
            get
            {
                return this[SAAbsorptionAttribute.SplinteringWeapon];
            }
            set
            {
                this[SAAbsorptionAttribute.SplinteringWeapon] = value;
            }
        }
    }
    ...
    public sealed class AosElementAttributes : BaseAttributes
    {
        ...
        public int this[AosElementAttribute attribute] { get { return ExtendedGetValue((int)attribute); } set { SetValue((int)attribute, value); } }

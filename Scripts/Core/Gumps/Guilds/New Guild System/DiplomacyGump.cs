...
namespace Server.Guilds
{
    ...
    public class GuildDiplomacyGump : BaseGuildListGump<Guild>
    {
        ...
        public GuildDiplomacyGump(PlayerMobile pm, Guild g)
            : this(pm, g, NameComparer.Instance, true, "", 0, GuildDisplayType.All, Utility.CastConvertList<BaseGuild, Guild>(new List<BaseGuild>(Guild.List.Values)), (1063136 + (int)GuildDisplayType.All))
        {
        }

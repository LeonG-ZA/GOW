...
namespace Server.ContextMenus
{
    public class AddToSpellbookEntry : ContextMenuEntry
    {
        ...
        {
            if (this.Owner.From.CheckAlive() && this.Owner.Target is BaseSpellScroll)
                this.Owner.From.Target = new InternalTarget((BaseSpellScroll)this.Owner.Target);
        }

        private class InternalTarget : Target
        {
            private readonly BaseSpellScroll m_Scroll;
            public InternalTarget(BaseSpellScroll scroll)

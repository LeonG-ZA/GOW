...
namespace Server
{
    ...
    {
        public const int DayLevel = MainConfig.MainDayLevel;
        public const int NightLevel = MainConfig.MainNightLevel;
        public const int DungeonLevel = MainConfig.MainDungeonLevel;
        public const int JailLevel = MainConfig.MainJailLevel;

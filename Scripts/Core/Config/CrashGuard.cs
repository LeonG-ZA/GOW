...
namespace Server.Misc
{
    ...
    {
        private static readonly bool SaveBackup = MainConfig.MainCrashSaveBackupEnabled;
        private static readonly bool RestartServer = MainConfig.MainCrashRestartServerEnabled;
        private static readonly bool GenerateReport = MainConfig.MainCrashGenerateReportEnabled;
        public static void Initialize()
        {
            if (MainConfig.MainCrashGuardEnabled)
        ...
        private static void SendEmail(string filePath)
        {
            ...
            message.Subject = "Automated GOW Crash Report";

            message.Body = "Automated GOW Crash Report. See attachment for details.";
        ...
        private static void GenerateCrashReport(CrashedEventArgs e)
        {
            ...
            {
                string timeStamp = GetTimeStamp();
                string fileName = String.Format(LogConfig.LogCrashGuard, timeStamp);
                ...
                using (StreamWriter op = new StreamWriter(filePath))
                {
                    ...
                    op.WriteLine("===================");
                    op.WriteLine();
                    op.WriteLine("GOW Version {0}.{1}, Build {2}.{3}", ver.Major, ver.Minor, ver.Build, ver.Revision);

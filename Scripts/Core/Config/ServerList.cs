...
namespace Server.Misc
{
    public class ServerList
    {
        ...
        * are private network addresses and AutoDetect is 'true' then Gen Of Worlds will attempt to discover your public IP address
        ...
        * a hostname that will be resolved when Gen Of Worlds starts.
        * 
        ...
        */
        public static readonly string Address = MainConfig.MainIPAddress;
        public static readonly string ServerName = MainConfig.MainServerName;
        public static readonly bool AutoDetect = MainConfig.MainAutoDetectEnabled;
        ...
        private static void AutoDetection()
        {
            if (!HasPublicIPAddress())
            {
                ...
                //Console.WriteLine("done ({0})", _PublicAddress.ToString());
                else

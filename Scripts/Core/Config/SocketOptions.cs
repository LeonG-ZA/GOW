...
namespace Server
{
    public class SocketOptions
    {
        ...
        {
            new IPEndPoint(IPAddress.Any, MainConfig.MainPort), // Default: Listen on port 2593 on all IP addresses
        ...
        private static void EventSink_SocketConnect(SocketConnectEventArgs e)
        {
            ...
            if (!NagleEnabled)
                e.Socket.SetSocketOption(SocketOptionLevel.Tcp, SocketOptionName.NoDelay, 1); // GOW uses its own algorithm
        }
    }
}
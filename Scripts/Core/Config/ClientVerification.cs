...
namespace Server.Misc
{
    ...
    {
        private static readonly bool m_DetectClientRequirement = ClientConfig.ClientDetectClientRequirementEnabled;
        private static readonly OldClientResponse m_OldClientResponse = OldClientResponse.LenientKick;
        private static readonly TimeSpan m_AgeLeniency = ClientConfig.ClientAgeLeniency;
        private static readonly TimeSpan m_GameTimeLeniency = ClientConfig.ClientGameTimeLeniency;
        private static ClientVersion m_Required;
        private static bool m_AllowRegular = ClientConfig.ClientAllowRegularEnabled, m_AllowUOTD = ClientConfig.ClientAllowUOTDEnabled, m_AllowGod = ClientConfig.ClientAllowGodEnabled;
        private static TimeSpan m_KickDelay = ClientConfig.ClientKickDelay;
        ...
        public static void Initialize()
        {
            ...
            if (Required != null)
            {
                ...
                Console.Write("G.O.W: Restricting client version to");
            ...
            {
                Utility.PushColor(ConsoleColor.White);
                Console.Write("G.O.W: Client Version Restrictions Enabled");
                Utility.PushColor(ConsoleColor.DarkGray);
                Console.Write("............................");
                Utility.PushColor(ConsoleColor.Gray);
            ...
            if (kickMessage != null)
            {
                ...
                Timer.DelayCall(KickDelay, delegate
                {
                    if (state.Socket != null)
                    {
                        ...
                        Console.WriteLine("G.O.W: Client: {0}: Disconnecting, bad version", state);
                        Utility.PopColor();
                        state.Dispose();
                    }
                });

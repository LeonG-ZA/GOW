...
namespace Server.Misc
{
    ...
    {
        private static readonly TimeSpan m_Delay = MainConfig.MainDelay;
        private static readonly TimeSpan m_Warning = MainConfig.MainWarning;
        ...
        private static bool m_SavesEnabled = MainConfig.MainSavesEnabled;
        public AutoSave()
        ...
        [Description("Enables or disables automatic GOW saving.")]
        ...
        public static void Save(bool permitBackgroundWrite)
        {
            ...
            if (MainConfig.BackupEnabled)
            {
                ...
                {
                    ErrorLog.WriteLine("WARNING: Automatic backup FAILED: {0}", e);
                }
            }

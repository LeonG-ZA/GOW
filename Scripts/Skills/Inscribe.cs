...
namespace Server.SkillHandlers
{
    public class Inscribe
    {
        ...
        {
            Target target = new InscribeTargetSrc();
            m.Target = target;
        ...
        private class InscribeTargetSrc : Target
        {
            public InscribeTargetSrc()
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                {
                    Target target = new InscribeTargetDst(book);
                    from.Target = target;
        ...
        private class InscribeTargetDst : Target
        {
            private readonly BaseBook m_BookSrc;
            public InscribeTargetDst(BaseBook bookSrc)
                : base(3, false, TargetFlags.None)
            {

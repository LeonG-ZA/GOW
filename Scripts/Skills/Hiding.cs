...
namespace Server.SkillHandlers
{
    public class Hiding
    {
        ...
        public static bool CombatOverride { get { return m_CombatOverride; } set { m_CombatOverride = value; } }
        ...
        public static TimeSpan OnUse(Mobile m)
        {
            ...
            int range = Math.Min((int)((100 - m.Skills[SkillName.Hiding].Value) / 2) + 8, Core.GlobalUpdateRange);	//Cap of 18 not OSI-exact, intentional difference

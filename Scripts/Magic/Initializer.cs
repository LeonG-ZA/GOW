        ...
        public static void Initialize()
        {
            ...
            if (Core.AOS)
            {
                ...
                if (Core.ML)
                {
                    ...
                    Register(603, typeof(Spellweaving.AttunementSpell));
                    Register(604, typeof(Spellweaving.ThunderstormSpell));
                    Register(605, typeof(Spellweaving.NaturesFurySpell));
                ...
                // Bard Spellsongs
                Register(700, typeof(Bard.Inspire));
                Register(701, typeof(Bard.Invigorate));
                Register(702, typeof(Bard.Resilience));
                Register(703, typeof(Bard.Perseverance));
                Register(704, typeof(Bard.Tribulation));
                Register(705, typeof(Bard.Despair));

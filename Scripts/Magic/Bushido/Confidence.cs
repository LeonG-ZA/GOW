...
namespace Server.Spells.Bushido
{
    public class Confidence : SamuraiSpell
    {
        ...
        {
            Timer t = null;
            m_RegenTable.TryGetValue(m, out t);
        ...
        private class ConfidenceTimer : Timer
        {
            private readonly Mobile m_Mobile;
            public ConfidenceTimer(Mobile m) : base(TimeSpan.FromSeconds(15.0))
            {
                this.m_Mobile = m;

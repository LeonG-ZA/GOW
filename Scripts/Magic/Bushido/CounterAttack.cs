...
namespace Server.Spells.Bushido
{
    public class CounterAttack : SamuraiSpell
    {
        ...
        private static readonly SpellInfo m_Info = new SpellInfo("CounterAttack", null, -1, 9002);
        ...
        private class CounterAttackTimer : Timer
        {
            private readonly Mobile m_Mobile;
            public CounterAttackTimer(Mobile m) : base(TimeSpan.FromSeconds(30.0))
            {
                this.m_Mobile = m;

...
namespace Server.Spells.First
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo( "Clumsy", "Uus Jux", 212, 9031, Reagent.Bloodmoss, Reagent.Nightshade);
        ...
        {
            this.Caster.Target = new ClumsySpellTarget(this);
        }
        ...
        private class ClumsySpellTarget : Target
        {
            private readonly ClumsySpell m_Owner;
            public ClumsySpellTarget(ClumsySpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.Harmful)
            {
                this.m_Owner = owner;
            }

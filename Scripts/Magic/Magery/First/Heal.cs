...
namespace Server.Spells.First
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Heal", "In Mani", 224, 9061, Reagent.Garlic, Reagent.Ginseng, Reagent.SpidersSilk);
        ...
        {
            Caster.Target = new HealSpellTarget(this);
        }
        ...
        public void Target(Mobile m)
        {
            ...
            else if (m is BaseCreature && ((BaseCreature)m).IsGolem)
            {
        ...
        public class HealSpellTarget : Target
        {
            private readonly HealSpell m_Owner;
            public HealSpellTarget(HealSpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.Beneficial)
            {
                m_Owner = owner;
            }

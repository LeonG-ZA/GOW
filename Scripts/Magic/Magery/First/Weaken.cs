...
namespace Server.Spells.First
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Weaken", "Des Mani", 212, 9031, Reagent.Garlic, Reagent.Nightshade);
        ...
        {
            this.Caster.Target = new WeakenSpellTarget(this);
        }
        ...
        public class WeakenSpellTarget : Target
        {
            private readonly WeakenSpell m_Owner;
            public WeakenSpellTarget(WeakenSpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.Harmful)
            {
                this.m_Owner = owner;
            }

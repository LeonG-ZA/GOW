...
namespace Server.Spells.First
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Magic Arrow", "In Por Ylem", 212, 9041, Reagent.SulfurousAsh);
        ...
        {
            this.Caster.Target = new MagicArrowSpellTarget(this);
        }
        ...
        private class MagicArrowSpellTarget : Target
        {
            private readonly MagicArrowSpell m_Owner;
            public MagicArrowSpellTarget(MagicArrowSpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.Harmful)
            {
                this.m_Owner = owner;
            }

...
namespace Server.Spells.First
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Feeblemind", "Rel Wis", 212, 9031, Reagent.Ginseng, Reagent.Nightshade);
        ...
        {
            this.Caster.Target = new FeeblemindSpellTarget(this);
        }
        ...
        private class FeeblemindSpellTarget : Target
        {
            private readonly FeeblemindSpell m_Owner;
            public FeeblemindSpellTarget(FeeblemindSpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.Harmful)
            {
                this.m_Owner = owner;
            }

...
namespace Server.Spells.Second
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Cunning", "Uus Wis", 212, 9061, Reagent.MandrakeRoot, Reagent.Nightshade);
        ...
        {
            this.Caster.Target = new CunningSpellTarget(this);
        }
        ...
        private class CunningSpellTarget : Target
        {
            private readonly CunningSpell m_Owner;
            public CunningSpellTarget(CunningSpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.Beneficial)
            {
                this.m_Owner = owner;
            }

...
namespace Server.Spells.Second
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Remove Trap", "An Jux", 212, 9001, Reagent.Bloodmoss, Reagent.SulfurousAsh);
        ...
        {
            this.Caster.Target = new RemoveTrapSpellTarget(this);
        ...
        private class RemoveTrapSpellTarget : Target
        {
            private readonly RemoveTrapSpell m_Owner;
            public RemoveTrapSpellTarget(RemoveTrapSpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.None)
            {
                this.m_Owner = owner;
            }

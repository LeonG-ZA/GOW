...
namespace Server.Spells.Second
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Strength", "Uus Mani", 212, 9061, Reagent.MandrakeRoot, Reagent.Nightshade);
        ...
        {
            this.Caster.Target = new StrengthSpellTarget(this);
        }
        ...
        private class StrengthSpellTarget : Target
        {
            private readonly StrengthSpell m_Owner;
            public StrengthSpellTarget(StrengthSpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.Beneficial)
            {
                this.m_Owner = owner;
            }

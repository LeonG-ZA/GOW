...
namespace Server.Spells.Second
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Harm", "An Mani", 212, Core.AOS ? 9001 : 9041, Reagent.Nightshade, Reagent.SpidersSilk);
        ...
        {
            this.Caster.Target = new HarmSpellTarget(this);
        }
        ...
        private class HarmSpellTarget : Target
        {
            private readonly HarmSpell m_Owner;
            public HarmSpellTarget(HarmSpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.Harmful)
            {
                this.m_Owner = owner;
            }

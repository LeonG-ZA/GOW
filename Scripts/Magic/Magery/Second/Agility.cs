...
namespace Server.Spells.Second
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Agility", "Ex Uus", 212, 9061, Reagent.Bloodmoss, Reagent.MandrakeRoot);
        ...
        {
            this.Caster.Target = new AgilitySpellTarget(this);
        }
        ...
        private class AgilitySpellTarget : Target
        {
            private readonly AgilitySpell m_Owner;
            public AgilitySpellTarget(AgilitySpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.Beneficial)
            {
                this.m_Owner = owner;
            }

...
namespace Server.Spells.Second
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Magic Trap", "In Jux", 212, 9001, Reagent.Garlic, Reagent.SpidersSilk, Reagent.SulfurousAsh);
        ...
        {
            this.Caster.Target = new MagicTrapSpellTarget(this);
        }
        ...
        private class MagicTrapSpellTarget : Target
        {
            private readonly MagicTrapSpell m_Owner;
            public MagicTrapSpellTarget(MagicTrapSpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.None)
            {
                this.m_Owner = owner;
            }

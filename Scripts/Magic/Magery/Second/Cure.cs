...
namespace Server.Spells.Second
{
    public class CureSpell : MagerySpell
    {
        ...
        {
            this.Caster.Target = new CureSpellTarget(this);
        }
        ...
        public class CureSpellTarget : Target
        {
            private readonly CureSpell m_Owner;
            public CureSpellTarget(CureSpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.Beneficial)
            {
                this.m_Owner = owner;
            }

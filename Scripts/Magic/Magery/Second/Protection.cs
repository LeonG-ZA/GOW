...
namespace Server.Spells.Second
{
    public class ProtectionSpell : MagerySpell
    {
        ...
        private static readonly SpellInfo m_Info = new SpellInfo("Protection", "Uus Sanct", 236, 9011, Reagent.Garlic, Reagent.Ginseng, Reagent.SulfurousAsh);
            ...
            else
            {
                ...
                else if (this.CheckSequence())
                {
                    if (this.Caster.BeginAction(typeof(DefensiveSpell)))
                    {
                        ...
                        new ProtectionSpellTimer(this.Caster).Start();
        ...
        private class ProtectionSpellTimer : Timer
        {
            private readonly Mobile m_Caster;
            public ProtectionSpellTimer(Mobile caster) : base(TimeSpan.FromSeconds(0))
            {

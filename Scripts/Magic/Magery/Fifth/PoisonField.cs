...
namespace Server.Spells.Fifth
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Poison Field", "In Nox Grav", 230, 9052, false, Reagent.BlackPearl, Reagent.Nightshade, Reagent.SpidersSilk);
        ...
        {
            this.Caster.Target = new PoisonFieldSpellTarget(this);
        }
        ...
        public void Target(IPoint3D p)
        {
            ...
            else if (SpellHelper.CheckTown(p, this.Caster) && this.CheckSequence())
            {
                ...
                for (int i = -2; i <= 2; ++i)
                {
                    ...
                    new PoisonFieldSpellItem(itemID, loc, this.Caster, this.Caster.Map, duration, i);
                }
            }
        ...
        [DispellableField]
        public class PoisonFieldSpellItem : Item
        {
            private Timer m_Timer;
            private DateTime m_End;
            private Mobile m_Caster;
            public PoisonFieldSpellItem(int itemID, Point3D loc, Mobile caster, Map map, TimeSpan duration, int val) : base(itemID)
            {
                ...
                this.m_Timer = new PoisonFieldSpellTimer(this, TimeSpan.FromSeconds(Math.Abs(val) * 0.2), caster.InLOS(this), canFit);
                this.m_Timer.Start();
            }

            public PoisonFieldSpellItem(Serial serial) : base(serial)
            {
            }
                    ...
                    case 0:
                        {
                            ...
                            this.m_Timer = new PoisonFieldSpellTimer(this, TimeSpan.Zero, true, true);
                            this.m_Timer.Start();
            ...
            private class PoisonFieldSpellTimer : Timer
            {
                private static readonly Queue m_Queue = new Queue();
                private readonly PoisonFieldSpellItem m_Item;
                private readonly bool m_InLOS;
                private readonly bool m_CanFit;
                public PoisonFieldSpellTimer(PoisonFieldSpellItem item, TimeSpan delay, bool inLOS, bool canFit) : base(delay, TimeSpan.FromSeconds(1.5))
                {
                    this.m_Item = item;
                    this.m_InLOS = inLOS;
        ...
        private class PoisonFieldSpellTarget : Target
        {
            private readonly PoisonFieldSpell m_Owner;
            public PoisonFieldSpellTarget(PoisonFieldSpell owner) : base(Core.ML ? 10 : 12, true, TargetFlags.None)
            {
                this.m_Owner = owner;
            }

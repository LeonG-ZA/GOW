...
namespace Server.Spells.Fifth
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Blade Spirits", "In Jux Hur Ylem", 266, 9040, false, Reagent.BlackPearl, Reagent.MandrakeRoot, Reagent.Nightshade);
        ...
        {
            this.Caster.Target = new BladeSpiritsSpellTarget(this);
        }
        ...
        private class BladeSpiritsSpellTarget : Target
        {
            private BladeSpiritsSpell m_Owner;
            public BladeSpiritsSpellTarget(BladeSpiritsSpell owner) : base(Core.ML ? 10 : 12, true, TargetFlags.None)
            {
                this.m_Owner = owner;
            }
            ...
            protected override void OnTargetOutOfLOS(Mobile from, object o)
            {
                ...
                from.Target = new BladeSpiritsSpellTarget(this.m_Owner);

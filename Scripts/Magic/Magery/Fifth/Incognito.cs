...
namespace Server.Spells.Fifth
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Incognito", "Kal In Ex", 206, 9002, Reagent.Bloodmoss, Reagent.Garlic, Reagent.Nightshade);
        ...
        public override void OnCast()
        {
            ...
            else if (this.CheckSequence())
            {
                if (this.Caster.BeginAction(typeof(IncognitoSpell)))
                {
                    ...
                    Timer t = new IncognitoSpellTimer(this.Caster, length);
        ...
        private class IncognitoSpellTimer : Timer
        {
            private readonly Mobile m_Owner;
            public IncognitoSpellTimer(Mobile owner, TimeSpan length) : base(length)
            {
                this.m_Owner = owner;

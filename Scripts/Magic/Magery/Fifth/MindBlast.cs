...
namespace Server.Spells.Fifth
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Mind Blast", "Por Corp Wis", 218, Core.AOS ? 9002 : 9032, Reagent.BlackPearl, Reagent.MandrakeRoot, Reagent.Nightshade, Reagent.SulfurousAsh);
        ...
        {
            this.Caster.Target = new MindBlastSpellTarget(this);
        }
        ...
        private class MindBlastSpellTarget : Target
        {
            private readonly MindBlastSpell m_Owner;
            public MindBlastSpellTarget(MindBlastSpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.Harmful)
            {
                this.m_Owner = owner;
            }

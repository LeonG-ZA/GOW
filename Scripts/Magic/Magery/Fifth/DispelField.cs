...
namespace Server.Spells.Fifth
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Dispel Field", "An Grav", 206, 9002, Reagent.BlackPearl, Reagent.SpidersSilk, Reagent.SulfurousAsh, Reagent.Garlic);
        ...
        {
            this.Caster.Target = new DispelFieldSpellTarget(this);
        }
        ...
        private class DispelFieldSpellTarget : Target
        {
            private readonly DispelFieldSpell m_Owner;
            public DispelFieldSpellTarget(DispelFieldSpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.None)
            {
                this.m_Owner = owner;
            }

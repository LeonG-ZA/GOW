...
namespace Server.Spells.Fifth
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Paralyze", "An Ex Por", 218, 9012, Reagent.Garlic, Reagent.MandrakeRoot, Reagent.SpidersSilk);
        ...
        {
            this.Caster.Target = new ParalyzeSpellarget(this);
        }
        ...
        public class ParalyzeSpellarget : Target
        {
            private readonly ParalyzeSpell m_Owner;
            public ParalyzeSpellarget(ParalyzeSpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.Harmful)
            {
                this.m_Owner = owner;
            }

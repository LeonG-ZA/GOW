...
namespace Server.Spells.Eighth
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Resurrection", "An Corp", 245, 9062, Reagent.Bloodmoss, Reagent.Garlic, Reagent.Ginseng);
        ...
        {
            this.Caster.Target = new ResurrectionSpellTarget(this);
        }
        ...
        private class ResurrectionSpellTarget : Target
        {
            private readonly ResurrectionSpell m_Owner;
            public ResurrectionSpellTarget(ResurrectionSpell owner)

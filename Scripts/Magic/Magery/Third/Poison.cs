...
namespace Server.Spells.Third
{
    public class PoisonSpell : MagerySpell
    {
        ...
        {
            this.Caster.Target = new PoisonSpellTarget(this);
        }
        ...
        private class PoisonSpellTarget : Target
        {
            private readonly PoisonSpell m_Owner;
            public PoisonSpellTarget(PoisonSpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.Harmful)
            {
                this.m_Owner = owner;
            }

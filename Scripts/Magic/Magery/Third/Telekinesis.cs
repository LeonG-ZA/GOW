...
namespace Server.Spells.Third
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Telekinesis", "Ort Por Ylem", 203, 9031, Reagent.Bloodmoss, Reagent.MandrakeRoot);
        ...
        {
            this.Caster.Target = new TelekinesisSpellTarget(this);
        }
        ...
        public class TelekinesisSpellTarget : Target
        {
            private readonly TelekinesisSpell m_Owner;
            public TelekinesisSpellTarget(TelekinesisSpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.None)
            {
                this.m_Owner = owner;
            }

...
namespace Server.Spells.Third
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Unlock Spell", "Ex Por", 215, 9001, Reagent.Bloodmoss, Reagent.SulfurousAsh);
        ...
        {
            this.Caster.Target = new UnlockSpellTarget(this);
        }

        private class UnlockSpellTarget : Target
        {
            private readonly UnlockSpell m_Owner;
            public UnlockSpellTarget(UnlockSpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.None)
            {
                this.m_Owner = owner;
            }

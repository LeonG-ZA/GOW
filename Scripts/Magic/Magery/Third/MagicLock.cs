...
namespace Server.Spells.Third
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Magic Lock", "An Por", 215, 9001, Reagent.Garlic, Reagent.Bloodmoss, Reagent.SulfurousAsh);
        ...
        {
            this.Caster.Target = new MagicLockSpellTarget(this);
        }
        ...
        private class MagicLockSpellTarget : Target
        {
            private readonly MagicLockSpell m_Owner;
            public MagicLockSpellTarget(MagicLockSpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.None)
            {
                this.m_Owner = owner;
            }

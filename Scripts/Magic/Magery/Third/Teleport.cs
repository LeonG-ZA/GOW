...
namespace Server.Spells.Third
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Teleport", "Rel Por", 215, 9031, Reagent.Bloodmoss, Reagent.MandrakeRoot);
        ...
        {
            this.Caster.Target = new TeleportSpellTarget(this);
        }
        ...
        public void Target(IPoint3D p)
        {
            ...
            else if (this.CheckSequence())
            {
                ...
                {
                    if (item is Server.Spells.Sixth.ParalyzeFieldSpell.InternalItem || item is Server.Spells.Fifth.PoisonFieldSpell.PoisonFieldSpellItem || item is Server.Spells.Fourth.FireFieldSpell.FireFieldItem)
                        item.OnMoveOver(m);
                }
        ...
        public class TeleportSpellTarget : Target
        {
            private readonly TeleportSpell m_Owner;
            public TeleportSpellTarget(TeleportSpell owner) : base(Core.ML ? 11 : 12, true, TargetFlags.None)
            {
                this.m_Owner = owner;
            }

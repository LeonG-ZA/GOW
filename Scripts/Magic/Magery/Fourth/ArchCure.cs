...
namespace Server.Spells.Fourth
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Arch Cure", "Vas An Nox", 215, 9061, Reagent.Garlic, Reagent.Ginseng, Reagent.MandrakeRoot);
        ...
        {
            this.Caster.Target = new ArchCureSpellTarget(this);
        }
        ...
        private class ArchCureSpellTarget : Target
        {
            private readonly ArchCureSpell m_Owner;
            public ArchCureSpellTarget(ArchCureSpell owner) : base(Core.ML ? 10 : 12, true, TargetFlags.None)
            {
                this.m_Owner = owner;
            }

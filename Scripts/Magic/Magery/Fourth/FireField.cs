...
namespace Server.Spells.Fourth
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Fire Field", "In Flam Grav", 215, 9041, false, Reagent.BlackPearl, Reagent.SpidersSilk, Reagent.SulfurousAsh);
        ...
        {
            this.Caster.Target = new FireFieldSpellTarget(this);
        }
        ...
        public class FireFieldItem : Item
        {
                ...
                : base(itemID)
            {
                ...
                this.m_Timer = new FireFieldSpellTimer(this, TimeSpan.FromSeconds(Math.Abs(val) * 0.2), caster.InLOS(this), canFit);
                this.m_Timer.Start();
            }
                    ...
                    case 0:
                        {
                            ...
                            this.m_Timer = new FireFieldSpellTimer(this, TimeSpan.Zero, true, true);
                            this.m_Timer.Start();
            ...
            public override bool OnMoveOver(Mobile m)
            {
                if (this.Visible && this.m_Caster != null && (!Core.AOS || m != this.m_Caster) && SpellHelper.ValidIndirectTarget(this.m_Caster, m) && this.m_Caster.CanBeHarmful(m, false))
                {
                    ...
                    ItemAttributes.Damage(m, this.m_Caster, damage, 0, 100, 0, 0, 0);
                    m.PlaySound(0x208);
            ...
            private class FireFieldSpellTimer : Timer
            {
                ...
                public FireFieldSpellTimer(FireFieldItem item, TimeSpan delay, bool inLOS, bool canFit) : base(delay, TimeSpan.FromSeconds(1.0))
                {
                    this.m_Item = item;
                    this.m_InLOS = inLOS;
                    ...
                    else
                    {
                        ...
                        if (map != null && caster != null)
                        {
                            ...
                            while (m_Queue.Count > 0)
                            {
                                ...
                                ItemAttributes.Damage(m, caster, damage, 0, 100, 0, 0, 0);
                                m.PlaySound(0x208);
        ...
        private class FireFieldSpellTarget : Target
        {
            private readonly FireFieldSpell m_Owner;
            public FireFieldSpellTarget(FireFieldSpell owner) : base(Core.ML ? 10 : 12, true, TargetFlags.None)
            {
                this.m_Owner = owner;
            }

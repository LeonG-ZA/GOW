...
namespace Server.Spells.Fourth
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Mana Drain", "Ort Rel", 215, 9031, Reagent.BlackPearl, Reagent.MandrakeRoot, Reagent.SpidersSilk);
        ...
        {
            this.Caster.Target = new ManaDrainSpellTarget(this);
        }
        ...
        private class ManaDrainSpellTarget : Target
        {
            private readonly ManaDrainSpell m_Owner;
            public ManaDrainSpellTarget(ManaDrainSpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.Harmful)
            {
                this.m_Owner = owner;
            }

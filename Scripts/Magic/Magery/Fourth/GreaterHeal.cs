...
namespace Server.Spells.Fourth
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Greater Heal", "In Vas Mani", 204, 9061, Reagent.Garlic, Reagent.Ginseng, Reagent.MandrakeRoot, Reagent.SpidersSilk);
        ...
        {
            this.Caster.Target = new GreaterHealSpellTarget(this);
        }
        ...
        public class GreaterHealSpellTarget : Target
        {
            private readonly GreaterHealSpell m_Owner;
            public GreaterHealSpellTarget(GreaterHealSpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.Beneficial)
            {
                this.m_Owner = owner;
            }

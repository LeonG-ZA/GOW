...
namespace Server.Spells.Seventh
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Mana Vampire", "Ort Sanct", 221, 9032, Reagent.BlackPearl, Reagent.Bloodmoss, Reagent.MandrakeRoot, Reagent.SpidersSilk);
        ...
        {
            this.Caster.Target = new ManaVampireSpellTarget(this);
        }
        ...
        private class ManaVampireSpellTarget : Target
        {
            private readonly ManaVampireSpell m_Owner;
            public ManaVampireSpellTarget(ManaVampireSpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.Harmful)
            {
                this.m_Owner = owner;
            }

...
namespace Server.Spells.Seventh
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Chain Lightning", "Vas Ort Grav", 209, 9022, false, Reagent.BlackPearl, Reagent.Bloodmoss, Reagent.MandrakeRoot, Reagent.SulfurousAsh);
        ...
        {
            this.Caster.Target = new ChainLightningSpellTarget(this);
        }
        ...
        private class ChainLightningSpellTarget : Target
        {
            private readonly ChainLightningSpell m_Owner;
            public ChainLightningSpellTarget(ChainLightningSpell owner) : base(Core.ML ? 10 : 12, true, TargetFlags.None)
            {
                this.m_Owner = owner;
            }

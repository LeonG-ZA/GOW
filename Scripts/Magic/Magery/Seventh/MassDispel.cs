...
namespace Server.Spells.Seventh
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Mass Dispel", "Vas An Ort", 263, 9002, Reagent.Garlic, Reagent.MandrakeRoot, Reagent.BlackPearl, Reagent.SulfurousAsh);
        ...
        {
            this.Caster.Target = new MassDispelSpellTarget(this);
        }
        ...
        private class MassDispelSpellTarget : Target
        {
            private readonly MassDispelSpell m_Owner;
            public MassDispelSpellTarget(MassDispelSpell owner) : base(Core.ML ? 10 : 12, true, TargetFlags.None)
            {
                this.m_Owner = owner;
            }

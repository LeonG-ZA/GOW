...
namespace Server.Spells.Seventh
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Polymorph", "Vas Ylem Rel", 221, 9002, Reagent.Bloodmoss, Reagent.SpidersSilk, Reagent.MandrakeRoot);
        ...
        public override bool CheckCast()
        {
            ...
            if (TransformationSpell.UnderTransformation(Caster))
            {
                ...
                if (Caster.BeginAction(typeof(PolymorphSpell)))
                {
                    if (m_NewBody != 0)
                    {
                        ...
                        if (!Core.ML)
                        {
                            ...
                            Timer t = new PolymorphSpellTimer(Caster);
        ...
        private class PolymorphSpellTimer : Timer
        {
            private readonly Mobile m_Owner;
            public PolymorphSpellTimer(Mobile owner) : base(TimeSpan.FromSeconds(0))
            {
                m_Owner = owner;

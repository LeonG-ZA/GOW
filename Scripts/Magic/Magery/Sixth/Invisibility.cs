...
namespace Server.Spells.Sixth
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Invisibility", "An Lor Xen", 206, 9002, Reagent.Bloodmoss, Reagent.Nightshade);
        ...
        {
            this.Caster.Target = new InvisibilitySpellTarget(this);
        }
        ...
        public void Target(Mobile m)
        {
            ...
            else if (this.CheckBSequence(m))
            {
                ...
                Timer t = new InvisibilitySpellTimer(m, duration);
        ...
        public class InvisibilitySpellTarget : Target
        {
            private readonly InvisibilitySpell m_Owner;
            public InvisibilitySpellTarget(InvisibilitySpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.Beneficial)
            {
                this.m_Owner = owner;
            }
        ...
        private class InvisibilitySpellTimer : Timer
        {
            private readonly Mobile m_Mobile;
            public InvisibilitySpellTimer(Mobile m, TimeSpan duration) : base(duration)
            {

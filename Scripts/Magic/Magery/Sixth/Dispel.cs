...
namespace Server.Spells.Sixth
{
    ...
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Dispel", "An Ort", 218, 9002, Reagent.Garlic, Reagent.MandrakeRoot, Reagent.SulfurousAsh);
        ...
        {
            this.Caster.Target = new DispelSpellTarget(this);
        }

        public class DispelSpellTarget : Target
        {
            private readonly DispelSpell m_Owner;
            public DispelSpellTarget(DispelSpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.Harmful)
            {
                this.m_Owner = owner;
            }

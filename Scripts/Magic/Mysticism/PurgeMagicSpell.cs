        ...
        private BeneficalWard[] m_Entries = new BeneficalWard[]
			{
				...
				new BeneficalWard( "Magic Reflection",	MagicReflectSpell.UnderEffect,		MagicReflectSpell.EndReflect, new MagicReflectSpell(null, null).MinimumCastSkill ),
				...
				new BeneficalWard( "Protection",		ProtectionSpell.UnderEffect,		ProtectionSpell.EndProtection, new ProtectionSpell(null, null).MinimumCastSkill ),
				...
				new BeneficalWard( "Reactive Armor",	ReactiveArmorSpell.UnderEffect,		ReactiveArmorSpell.EndArmor, new ReactiveArmorSpell(null, null).MinimumCastSkill ),

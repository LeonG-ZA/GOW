...
namespace Server.Spells.Bard
{
	public abstract class AreaSpellsong : Spellsong
	{
        ...
        //private ISet<AosAttributes> m_Mods;
		...
		{
            //m_Mods = new HashSet<AosAttributes>();
			m_StatMods = new HashSet<StatMod>();

			AddMods( /*m_Mods,*/ m_StatMods );
		}

        protected virtual void AddMods(/*ISet<AosAttributes> mods ,*/ ISet<StatMod> statMods)
		{
		}
		...
		protected override void OnTargetAdded( Mobile m )
		{
            ...
            /*foreach (AosAttributes mod in m_Mods)
			{
                AosAttributes.GetValue(mod);
			}
             */

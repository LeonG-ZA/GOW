...
namespace Server.Spells.Bard
{
	public class Invigorate : AreaSpellsong
	{
		...
		protected override void AddMods( /*ISet<AttributeMod> mods,*/ ISet<StatMod> statMods )
		{
            ...
            statMods.Add(new StatMod(StatType.Str, "Invigorate Str", statBonus, TimeSpan.Zero));
            statMods.Add(new StatMod(StatType.Dex, "Invigorate Dex", statBonus, TimeSpan.Zero));
            statMods.Add(new StatMod(StatType.Int, "Invigorate Int", statBonus, TimeSpan.Zero));

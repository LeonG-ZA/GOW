...
namespace Server
{
	public class Lib
	{
		...
		public static List<string> ListOfLines( string WorkingFolder, string FileName ) // = "Data/MyExamples" and "Example.cfg"
		{
			...
			string basic_path = Path.Combine( Core.BaseDirectory, folders ); // = "C:/Shard/Data/MyExamples/Example.cfg"
			string path = basic_path.Replace("/","\\"); // = "C:\Shard\Data\MyExamples\Example.cfg"

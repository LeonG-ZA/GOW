...
namespace Server
{
    public class DoorGeneratorT2A
    {
        ...
        {
            CommandSystem.Register("DoorGenT2A", AccessLevel.Administrator, new CommandEventHandler(DoorGenT2A_OnCommand));
        }

        [Usage("DoorGenT2A")]
        [Description("Generates doors by analyzing the map. Slow.")]
        public static void DoorGenT2A_OnCommand(CommandEventArgs e)
        {
            Generate();
        }

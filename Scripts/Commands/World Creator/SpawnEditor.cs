...
namespace Server.Gumps
{
    public class SpawnEditorGump : Gump
    {
        ...
        public static void SpawnEditor_OnCommand(Mobile from)
        {
            ...
            Type type = ScriptCompiler.FindTypeByName("PrimeSpawner", true);
            ...
            else
            {
                if (page == 0)
                {
                    ...
                    for (int x = 0; x < listnum; x++)
                    {
                        ...
                        {
                            gumpMsg = "PrimeSpawner at " + spawnr.X.ToString() + ", " + spawnr.Y.ToString();
                        }
                        else
                        {
        ...
        public void InitializeSelectedRightPanel()
        {
            ...
            string spnText = "PrimeSpawner at " + spX + ", " + spY;

            AddLabel(350, 65, 52, spnText);

            PrimeSpawner initSpn = selSpawner as PrimeSpawner;
            int strNum = 0;

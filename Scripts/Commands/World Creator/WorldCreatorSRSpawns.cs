...
{
	public class WorldCreatorSRSpawns
	{
		...
		{
            e.Mobile.CloseGump(typeof(GumpSaveRegion));
		...
		{
            e.Mobile.CloseGump(typeof(GumpSaveCoordinate));
		...
		{
            e.Mobile.CloseGump(typeof(GumpRemoveID));
		...
		{
            e.Mobile.CloseGump(typeof(GumpRemoveCoordinate));
		...
		{
            e.Mobile.CloseGump(typeof(GumpRemoveRegion));
...
namespace Server.Gumps
{
	public class GumpSaveRegion : Gump
	{
		...
		public GumpSaveRegion( CommandEventArgs e ) : base( 50,50 )
		{
			...
			AddHtml( 15, 80, 200, 110, "This will SAVE the spawners, in a specified region, to Data/World/Spawns/'region name'.map. Type [where if you don't know the region you are. Copy to the text box the name of the region. You also can open Data/World/Regions.xml to a full list of regions.<BR>Example: you type [where and appear 'your region is town of Britain'. Type 'Britain' in text box.", true, true );
		}

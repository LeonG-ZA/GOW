...
namespace Server.Custom
{
	public class SearchImageCommand
    {
		...
		public static void Initialize()
        {
            ...
            Console.Write("G.O.W: Image List");
	...
	public class SearchImageGump : Gump
	{
            ...
            : base(0, 54)
        {
            ...
            if (m_ShowImage)
            {
                ...
                AddButtonTileArt(737, 148, 22400, 22400, GumpButtonType.Reply, 50, 0, 0, 0, 80, 20, 1078519);
            }
            else
            {
                AddBackground(729, 146, 31, 25, 0x13BE);
                AddButtonTileArt(737, 148, 22402, 22402, GumpButtonType.Reply, 50, 0, 0, 0, 80, 20, 1078518);
            }
                ...
                if (list != null && list.Count > 0)
                {
                    ...
                    for (int q = index; q < index + num; q++)
                    {
                        try
                        {
                            ...
                            AddButtonTileArt(x + 5, 90, 4030, 4031, GumpButtonType.Reply, list[q] + 100000, 0, 1352, 0, 140, 20, 500927);
                            AddButtonTileArt(x + 35, 90, 4009, 4010, GumpButtonType.Reply, list[q] + 200000, 0, 1352, 0, 140, 20, 1027024);
                            AddLabel(x + 5, 115, 20, "Details");
                            AddButtonTileArt(x + 49, 118, 1210, 1210, GumpButtonType.Reply, list[q] + 300000, 0, 1352, 0, 140, 20, 1049074);

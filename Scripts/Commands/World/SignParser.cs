...
namespace Server.Commands
{
    public class SignParser
    {
        ...
        public static void Parse(Mobile from)
        {
            ...
            List<SignEntry> list = SignEntry.LoadConfig("Data/World/Signs/signs.cfg");
        ...
        private class SignRemoveTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object o)
            {
                ...
                List<SignEntry> signs = SignEntry.LoadConfig("Data/World/Signs/signs.cfg");
                foreach (SignEntry sign in signs)
                {
                ...
                if (toRemove != null)
                {
                    ...
                    SignEntry.WriteConfig(signs, "Data/World/Signs/signs.cfg");
                }
                else
                {

...
namespace Server.Commands
{
	public class Recover
	{
		...
		public static void Register()
		{
            ...
            CommandSystem.Register("Resurrect", AccessLevel.GameMaster, new CommandEventHandler(Recover_OnCommand));
            CommandSystem.Register("Res", AccessLevel.GameMaster, new CommandEventHandler(Recover_OnCommand));
		}

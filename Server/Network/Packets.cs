...
namespace Server.Network
{
    ...
    public sealed class DisplayEquipmentInfo : Packet
    {
            ...
            : base(0xBF)
        {
            ...
            EnsureCapacity(17 + (info.Crafter == null ? 0 : 6 + info.Crafter.TitleName == null ? 0 : info.Crafter.TitleName.Length) + (info.Unidentified ? 4 : 0) + (attrs.Length * 6));  
    ...
    {
        private static readonly SeasonChange[][] m_Cache = new SeasonChange[5][] { new SeasonChange[2], new SeasonChange[2], new SeasonChange[2], new SeasonChange[2], new SeasonChange[2] };
    ...
    {
        public NewMobileAnimation(Mobile m, int action, int subAction)
            : base(0xE2, 10)
        {
            m_Stream.Write((int)m.Serial);
            m_Stream.Write((short)action);
    ...
    public sealed class MobileStatusExtended : Packet
    {
            ...
            : base(0x11)
        {
            ...
            if (Core.TOL && ns != null && ns.ExtendedStatus)
            {
                type = 6;
                EnsureCapacity(121);
            }
...
///bool IsKRClient = beholder.NetState != null && beholder.NetState.Version.IsKRClient;
           ...
           //// else if (IsKRClient)
            //{
           //     type = 6;
                //EnsureCapacity(161);//149
           // }
            else if (Core.TOL && ns != null && ns.ExtendedStatus)
            {
                type = 6;
                EnsureCapacity(121);
            }
            ...
            : base(0x78)
        {
            ...
            if (beheld.FaceItemID > 0)
            {
                if (m_DupedLayers[(int)Layer.Face] != m_Version)
                {
                    ...
                    int itemID = beheld.FaceItemID & 0x7FFF;
    ...
    {
        public static readonly Packet Instance = Packet.SetStatic(new ConfirmDrop());

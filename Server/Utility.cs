...
#pragma warning restore 618
		...
		{
            return (p1.m_X >= (p2.m_X - Core.GlobalUpdateRange)) && (p1.m_X <= (p2.m_X + Core.GlobalUpdateRange)) && (p1.m_Y >= (p2.m_Y - Core.GlobalUpdateRange)) &&
                   (p1.m_Y <= (p2.m_Y + Core.GlobalUpdateRange));
		}
		...
		{
            return (p1.X >= (p2.X - Core.GlobalUpdateRange)) && (p1.X <= (p2.X + Core.GlobalUpdateRange)) && (p1.Y >= (p2.Y - Core.GlobalUpdateRange)) && (p1.Y <= (p2.Y + Core.GlobalUpdateRange));
		}
		#endregion
